...
func (o *BTPStatementLoopFor3278) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPStatementLoopFor3278) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPStatementLoopFor3278) SetDocumentationType(v string) {
