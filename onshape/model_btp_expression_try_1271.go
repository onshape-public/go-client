...
func (o *BTPExpressionTry1271) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPExpressionTry1271) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPExpressionTry1271) SetDocumentationType(v string) {
