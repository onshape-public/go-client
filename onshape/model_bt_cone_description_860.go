...
func (o *BTConeDescription860) GetType() GBTSurfaceTypeEnum {
	if o == nil || o.Type == nil {
...
// and a boolean to check if the value has been set.
func (o *BTConeDescription860) GetTypeOk() (*GBTSurfaceTypeEnum, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return o.Type, true
...
func (o *BTConeDescription860) SetType(v GBTSurfaceTypeEnum) {
	o.Type = &v
}
