...
func (o BTFSValueArray1499AllOf) MarshalJSON() ([]byte, error) {
...
type NullableBTFSValueArray1499AllOf struct {
	value *BTFSValueArray1499AllOf
	isSet bool
}

func (v NullableBTFSValueArray1499AllOf) Get() *BTFSValueArray1499AllOf {
	return v.value
}

func (v *NullableBTFSValueArray1499AllOf) Set(val *BTFSValueArray1499AllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBTFSValueArray1499AllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBTFSValueArray1499AllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTFSValueArray1499AllOf(val *BTFSValueArray1499AllOf) *NullableBTFSValueArray1499AllOf {
	return &NullableBTFSValueArray1499AllOf{value: val, isSet: true}
}

func (v NullableBTFSValueArray1499AllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTFSValueArray1499AllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
