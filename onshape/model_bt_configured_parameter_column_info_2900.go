...
func (o *BTConfiguredParameterColumnInfo2900) GetParentType() GBTConfiguredParentType {
...
// and a boolean to check if the value has been set.
func (o *BTConfiguredParameterColumnInfo2900) GetParentTypeOk() (*GBTConfiguredParentType, bool) {
	if o == nil || o.ParentType == nil {
		return nil, false
	}
...
func (o *BTConfiguredParameterColumnInfo2900) SetParentType(v GBTConfiguredParentType) {
	o.ParentType = &v
}
