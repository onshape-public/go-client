...
func (o *BTParameterSpecNullableQuantity715) GetUiHints() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecNullableQuantity715) GetUiHintsOk() ([]string, bool) {
	if o == nil || o.UiHints == nil {
		return nil, false
	}
...
func (o *BTParameterSpecNullableQuantity715) SetUiHints(v []string) {
	o.UiHints = v
}
