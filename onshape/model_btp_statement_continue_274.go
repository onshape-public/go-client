...
func (o *BTPStatementContinue274) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPStatementContinue274) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPStatementContinue274) SetDocumentationType(v string) {
