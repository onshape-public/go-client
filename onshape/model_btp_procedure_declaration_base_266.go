...
// BTPFunctionDeclaration246AsBTPProcedureDeclarationBase266 is a convenience function that returns BTPFunctionDeclaration246 wrapped in BTPProcedureDeclarationBase266
func (o *BTPFunctionDeclaration246) AsBTPProcedureDeclarationBase266() *BTPProcedureDeclarationBase266 {
	return &BTPProcedureDeclarationBase266{o}
}
...
func (o *BTPProcedureDeclarationBase266) GetDocumentationType() string {
	type getResult interface {
...
// and a boolean to check if the value has been set.
func (o *BTPProcedureDeclarationBase266) GetDocumentationTypeOk() (*string, bool) {
	type getResult interface {
...
func (o *BTPProcedureDeclarationBase266) SetDocumentationType(v string) {
	type getResult interface {
...
func (dst *BTPProcedureDeclarationBase266) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["btType"] == "BTPFunctionDeclaration-246" {
		...
		if err == nil {
			...
			dst.implBTPProcedureDeclarationBase266 = nil
			return fmt.Errorf("Failed to unmarshal BTPProcedureDeclarationBase266 as BTPFunctionDeclaration246: %s", err.Error())
		}
	}
...
// GetDocumentationType returns the DocumentationType field value if set, zero value otherwise.
func (o *base_BTPProcedureDeclarationBase266) GetDocumentationType() string {
...
// GetDocumentationTypeOk returns a tuple with the DocumentationType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTPProcedureDeclarationBase266) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
// SetDocumentationType gets a reference to the given string and assigns it to the DocumentationType field.
func (o *base_BTPProcedureDeclarationBase266) SetDocumentationType(v string) {
