...
func (o *BTParameterSpecForeignId172) GetEnumOptions() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecForeignId172) GetEnumOptionsOk() ([]string, bool) {
	if o == nil || o.EnumOptions == nil {
		return nil, false
	}
...
func (o *BTParameterSpecForeignId172) HasEnumOptions() bool {
	if o != nil && o.EnumOptions != nil {
		return true
	}
...
func (o *BTParameterSpecForeignId172) SetEnumOptions(v []string) {
	o.EnumOptions = v
}
