...
func (o *BTParameterSpecForeignId172) GetUiHints() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecForeignId172) GetUiHintsOk() ([]string, bool) {
	if o == nil || o.UiHints == nil {
		return nil, false
	}
...
func (o *BTParameterSpecForeignId172) SetUiHints(v []string) {
	o.UiHints = v
}
