...
func (o *BTParameterSpecReferenceCADImport1792) GetUiHints() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecReferenceCADImport1792) GetUiHintsOk() ([]string, bool) {
	if o == nil || o.UiHints == nil {
		return nil, false
	}
...
func (o *BTParameterSpecReferenceCADImport1792) SetUiHints(v []string) {
	o.UiHints = v
}
