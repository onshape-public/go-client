...
// BTParameterSpecNotice3132AsBTParameterSpec6 is a convenience function that returns BTParameterSpecNotice3132 wrapped in BTParameterSpec6
func (o *BTParameterSpecNotice3132) AsBTParameterSpec6() *BTParameterSpec6 {
	return &BTParameterSpec6{o}
}
...
// BTParameterSpecIcon4779AsBTParameterSpec6 is a convenience function that returns BTParameterSpecIcon4779 wrapped in BTParameterSpec6
func (o *BTParameterSpecIcon4779) AsBTParameterSpec6() *BTParameterSpec6 {
	return &BTParameterSpec6{o}
}
...
// BTParameterSpecReferenceVariableStudio1060AsBTParameterSpec6 is a convenience function that returns BTParameterSpecReferenceVariableStudio1060 wrapped in BTParameterSpec6
func (o *BTParameterSpecReferenceVariableStudio1060) AsBTParameterSpec6() *BTParameterSpec6 {
	return &BTParameterSpec6{o}
}
...
func (dst *BTParameterSpec6) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["btType"] == "BTParameterSpecIcon-4779" {
		...
		if err == nil {
			...
			dst.implBTParameterSpec6 = nil
			return fmt.Errorf("failed to unmarshal BTParameterSpec6 as BTParameterSpecIcon4779: %s", err.Error())
		}
	}
	...
	if jsonDict["btType"] == "BTParameterSpecNotice-3132" {
		...
		if err == nil {
			...
			dst.implBTParameterSpec6 = nil
			return fmt.Errorf("failed to unmarshal BTParameterSpec6 as BTParameterSpecNotice3132: %s", err.Error())
		}
	}
	...
	// check if the discriminator value is 'BTParameterSpecReferenceVariableStudio-1060'
	if jsonDict["btType"] == "BTParameterSpecReferenceVariableStudio-1060" {
		// try to unmarshal JSON data into BTParameterSpecReferenceVariableStudio1060
		var qr *BTParameterSpecReferenceVariableStudio1060
		err = json.Unmarshal(data, &qr)
		if err == nil {
			dst.implBTParameterSpec6 = qr
			return nil // data stored, return on the first match
			...
			dst.implBTParameterSpec6 = nil
			return fmt.Errorf("failed to unmarshal BTParameterSpec6 as BTParameterSpecReferenceVariableStudio1060: %s", err.Error())
		}
	}
...
// GetEnumOptions returns the EnumOptions field value if set, zero value otherwise.
func (o *base_BTParameterSpec6) GetEnumOptions() []string {
...
// GetEnumOptionsOk returns a tuple with the EnumOptions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTParameterSpec6) GetEnumOptionsOk() ([]string, bool) {
	if o == nil || o.EnumOptions == nil {
		return nil, false
	}
...
// HasEnumOptions returns a boolean if a field has been set.
func (o *base_BTParameterSpec6) HasEnumOptions() bool {
	if o != nil && o.EnumOptions != nil {
		return true
	}
...
// SetEnumOptions gets a reference to the given []string and assigns it to the EnumOptions field.
func (o *base_BTParameterSpec6) SetEnumOptions(v []string) {
	o.EnumOptions = v
}
