...
func (o *BTAssemblySimulationTable3236) GetStatusMessage() string {
...
// and a boolean to check if the value has been set.
func (o *BTAssemblySimulationTable3236) GetStatusMessageOk() (*string, bool) {
	if o == nil || o.StatusMessage == nil {
		return nil, false
	}
...
func (o *BTAssemblySimulationTable3236) HasStatusMessage() bool {
	if o != nil && o.StatusMessage != nil {
		return true
	}
...
func (o *BTAssemblySimulationTable3236) SetStatusMessage(v string) {
	o.StatusMessage = &v
}

// GetStatusType returns the StatusType field value if set, zero value otherwise.
func (o *BTAssemblySimulationTable3236) GetStatusType() GBTNodeStatusType {
...
// and a boolean to check if the value has been set.
func (o *BTAssemblySimulationTable3236) GetStatusTypeOk() (*GBTNodeStatusType, bool) {
	if o == nil || o.StatusType == nil {
		return nil, false
	}
...
func (o *BTAssemblySimulationTable3236) HasStatusType() bool {
	if o != nil && o.StatusType != nil {
		return true
	}
...
func (o *BTAssemblySimulationTable3236) SetStatusType(v GBTNodeStatusType) {
	o.StatusType = &v
}
