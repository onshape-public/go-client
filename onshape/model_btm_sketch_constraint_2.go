...
func (o *BTMSketchConstraint2) GetName() string {
	if o == nil || o.Name == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BTMSketchConstraint2) GetNameOk() (*string, bool) {
	if o == nil || o.Name == nil {
		return nil, false
	}
	return o.Name, true
...
func (o *BTMSketchConstraint2) HasName() bool {
	if o != nil && o.Name != nil {
		return true
	}
...
func (o *BTMSketchConstraint2) SetName(v string) {
	o.Name = &v
}
