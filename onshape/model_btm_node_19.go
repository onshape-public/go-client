...
// BTMSketchCurvedTextEntity5708AsBTMNode19 is a convenience function that returns BTMSketchCurvedTextEntity5708 wrapped in BTMNode19
func (o *BTMSketchCurvedTextEntity5708) AsBTMNode19() *BTMNode19 {
	return &BTMNode19{o}
}
...
func (dst *BTMNode19) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["btType"] == "BTMSketchCurvedTextEntity-5708" {
		...
		if err == nil {
			...
			dst.implBTMNode19 = nil
			return fmt.Errorf("failed to unmarshal BTMNode19 as BTMSketchCurvedTextEntity5708: %s", err.Error())
		}
	}
