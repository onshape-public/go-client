...
// GetConfirmationRequestedOk returns a tuple with the ConfirmationRequested field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTUserSummaryInfo) GetConfirmationRequestedOk() (*bool, bool) {
	if o == nil || o.ConfirmationRequested == nil {
		return nil, false
	}
...
// HasConfirmationRequested returns a boolean if a field has been set.
func (o *base_BTUserSummaryInfo) HasConfirmationRequested() bool {
	if o != nil && o.ConfirmationRequested != nil {
		return true
	}
...
// SetConfirmationRequested gets a reference to the given bool and assigns it to the ConfirmationRequested field.
func (o *base_BTUserSummaryInfo) SetConfirmationRequested(v bool) {
...
// GetIsExternal returns the IsExternal field value if set, zero value otherwise.
func (o *base_BTUserSummaryInfo) GetIsExternal() bool {
...
// GetIsExternalOk returns a tuple with the IsExternal field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTUserSummaryInfo) GetIsExternalOk() (*bool, bool) {
	if o == nil || o.IsExternal == nil {
		return nil, false
	}
...
// HasIsExternal returns a boolean if a field has been set.
func (o *base_BTUserSummaryInfo) HasIsExternal() bool {
	if o != nil && o.IsExternal != nil {
		return true
	}
...
// SetIsExternal gets a reference to the given bool and assigns it to the IsExternal field.
func (o *base_BTUserSummaryInfo) SetIsExternal(v bool) {
	o.IsExternal = &v
}
