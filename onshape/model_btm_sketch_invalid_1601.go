...
func (o *BTMSketchInvalid1601) GetName() string {
	if o == nil || o.Name == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BTMSketchInvalid1601) GetNameOk() (*string, bool) {
	if o == nil || o.Name == nil {
		return nil, false
	}
	return o.Name, true
...
func (o *BTMSketchInvalid1601) HasName() bool {
	if o != nil && o.Name != nil {
		return true
	}
...
func (o *BTMSketchInvalid1601) SetName(v string) {
	o.Name = &v
}
