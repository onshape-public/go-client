...
func (o *BTPStatementBlock271) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPStatementBlock271) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPStatementBlock271) SetDocumentationType(v string) {
