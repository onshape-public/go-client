...
`func (o *BTDocumentInfo) GetConnectionName() string`

GetConnectionName returns the ConnectionName field if non-nil, zero value otherwise.

### GetConnectionNameOk

`func (o *BTDocumentInfo) GetConnectionNameOk() (*string, bool)`
...
`func (o *BTDocumentInfo) SetConnectionName(v string)`

SetConnectionName sets ConnectionName field to given value.

### HasConnectionName

`func (o *BTDocumentInfo) HasConnectionName() bool`

HasConnectionName returns a boolean if a field has been set.

### GetConnectionNames

`func (o *BTDocumentInfo) GetConnectionNames() []string`

GetConnectionNames returns the ConnectionNames field if non-nil, zero value otherwise.

### GetConnectionNamesOk

`func (o *BTDocumentInfo) GetConnectionNamesOk() (*[]string, bool)`
...
`func (o *BTDocumentInfo) SetConnectionNames(v []string)`

SetConnectionNames sets ConnectionNames field to given value.

### HasConnectionNames

`func (o *BTDocumentInfo) HasConnectionNames() bool`
...
`func (o *BTDocumentInfo) GetIsExternalConnectionResource() bool`
...
`func (o *BTDocumentInfo) GetIsExternalConnectionResourceOk() (*bool, bool)`
...
`func (o *BTDocumentInfo) SetIsExternalConnectionResource(v bool)`

SetIsExternalConnectionResource sets IsExternalConnectionResource field to given value.

### HasIsExternalConnectionResource

`func (o *BTDocumentInfo) HasIsExternalConnectionResource() bool`
