...
func main() {
    cid := "cid_example" // string | Company ID
    sortColumn := "sortColumn_example" // string | `createdAt | modifiedAt | name | firstName | lastName | email | light | lastLoginTime | userRole | state | offBoardingDate | makePersonalCopies` (optional) (default to "createdAt")
 ...
 **sortColumn** | **string** | &#x60;createdAt | modifiedAt | name | firstName | lastName | email | light | lastLoginTime | userRole | state | offBoardingDate | makePersonalCopies&#x60; | [default to &quot;createdAt&quot;]
