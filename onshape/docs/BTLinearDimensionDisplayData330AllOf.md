...
**WitnessExtensionCurve** | Pointer to [**BTCurveDisplayData4722**](BTCurveDisplayData4722.md) |  | [optional] 
...
### GetWitnessExtensionCurve

`func (o *BTLinearDimensionDisplayData330AllOf) GetWitnessExtensionCurve() BTCurveDisplayData4722`

GetWitnessExtensionCurve returns the WitnessExtensionCurve field if non-nil, zero value otherwise.

### GetWitnessExtensionCurveOk

`func (o *BTLinearDimensionDisplayData330AllOf) GetWitnessExtensionCurveOk() (*BTCurveDisplayData4722, bool)`

GetWitnessExtensionCurveOk returns a tuple with the WitnessExtensionCurve field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetWitnessExtensionCurve

`func (o *BTLinearDimensionDisplayData330AllOf) SetWitnessExtensionCurve(v BTCurveDisplayData4722)`

SetWitnessExtensionCurve sets WitnessExtensionCurve field to given value.

### HasWitnessExtensionCurve

`func (o *BTLinearDimensionDisplayData330AllOf) HasWitnessExtensionCurve() bool`
