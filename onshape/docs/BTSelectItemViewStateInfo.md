...
**StandardContentSource** | Pointer to **int32** |  | [optional] 
...
### GetStandardContentSource

`func (o *BTSelectItemViewStateInfo) GetStandardContentSource() int32`

GetStandardContentSource returns the StandardContentSource field if non-nil, zero value otherwise.

### GetStandardContentSourceOk

`func (o *BTSelectItemViewStateInfo) GetStandardContentSourceOk() (*int32, bool)`

GetStandardContentSourceOk returns a tuple with the StandardContentSource field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetStandardContentSource

`func (o *BTSelectItemViewStateInfo) SetStandardContentSource(v int32)`

SetStandardContentSource sets StandardContentSource field to given value.

### HasStandardContentSource
