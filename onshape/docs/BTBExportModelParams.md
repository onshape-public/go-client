...
**UseYAxisAsUp** | Pointer to **bool** | If &#x60;true&#x60;, the exported file will have all the parts and assemblies reoriented such that the Z-axis within Onshape becomes the Y-axis in the exported file. | [optional] 
