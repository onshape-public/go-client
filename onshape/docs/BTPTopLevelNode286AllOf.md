...
**TopLevelType** | Pointer to [**GBTPDefinitionType**](GBTPDefinitionType.md) |  | [optional] 
...
`func (o *BTPTopLevelNode286AllOf) GetTopLevelType() GBTPDefinitionType`

GetTopLevelType returns the TopLevelType field if non-nil, zero value otherwise.

### GetTopLevelTypeOk

`func (o *BTPTopLevelNode286AllOf) GetTopLevelTypeOk() (*GBTPDefinitionType, bool)`

GetTopLevelTypeOk returns a tuple with the TopLevelType field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetTopLevelType

`func (o *BTPTopLevelNode286AllOf) SetTopLevelType(v GBTPDefinitionType)`

SetTopLevelType sets TopLevelType field to given value.

### HasTopLevelType

`func (o *BTPTopLevelNode286AllOf) HasTopLevelType() bool`
