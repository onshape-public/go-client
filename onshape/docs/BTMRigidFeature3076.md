...
### NewBTMRigidFeature3076

`func NewBTMRigidFeature3076() *BTMRigidFeature3076`

NewBTMRigidFeature3076 instantiates a new BTMRigidFeature3076 object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewBTMRigidFeature3076WithDefaults

`func NewBTMRigidFeature3076WithDefaults() *BTMRigidFeature3076`

NewBTMRigidFeature3076WithDefaults instantiates a new BTMRigidFeature3076 object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetBtType

`func (o *BTMRigidFeature3076) GetBtType() string`

GetBtType returns the BtType field if non-nil, zero value otherwise.

### GetBtTypeOk

`func (o *BTMRigidFeature3076) GetBtTypeOk() (*string, bool)`
...
`func (o *BTMRigidFeature3076) SetBtType(v string)`

SetBtType sets BtType field to given value.

### HasBtType

`func (o *BTMRigidFeature3076) HasBtType() bool`

HasBtType returns a boolean if a field has been set.

### GetFieldIndexForSuppressedInSimulationsMap

`func (o *BTMRigidFeature3076) GetFieldIndexForSuppressedInSimulationsMap() int32`
...
`func (o *BTMRigidFeature3076) GetFieldIndexForSuppressedInSimulationsMapOk() (*int32, bool)`
...
`func (o *BTMRigidFeature3076) SetFieldIndexForSuppressedInSimulationsMap(v int32)`
...
`func (o *BTMRigidFeature3076) HasFieldIndexForSuppressedInSimulationsMap() bool`

HasFieldIndexForSuppressedInSimulationsMap returns a boolean if a field has been set.

### GetSuppressedInSimulations

`func (o *BTMRigidFeature3076) GetSuppressedInSimulations() map[string]int32`
...
`func (o *BTMRigidFeature3076) GetSuppressedInSimulationsOk() (*map[string]int32, bool)`
...
`func (o *BTMRigidFeature3076) SetSuppressedInSimulations(v map[string]int32)`

SetSuppressedInSimulations sets SuppressedInSimulations field to given value.

### HasSuppressedInSimulations

`func (o *BTMRigidFeature3076) HasSuppressedInSimulations() bool`
