...
**Notes** | Pointer to **string** | Deprecated. Use the /documents/{did}/notes endpoint instead. | [optional] 
**OldClientNotes** | Pointer to **string** | Deprecated. Use the /documents/{did}/notes endpoint instead. | [optional] 
