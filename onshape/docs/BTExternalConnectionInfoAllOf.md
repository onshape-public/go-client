...
`func (o *BTExternalConnectionInfoAllOf) GetApprovedBy() BTUserSummaryInfo`

GetApprovedBy returns the ApprovedBy field if non-nil, zero value otherwise.

### GetApprovedByOk

`func (o *BTExternalConnectionInfoAllOf) GetApprovedByOk() (*BTUserSummaryInfo, bool)`
...
`func (o *BTExternalConnectionInfoAllOf) SetApprovedBy(v BTUserSummaryInfo)`
...
`func (o *BTExternalConnectionInfoAllOf) GetContactUser() BTUserSummaryInfo`

GetContactUser returns the ContactUser field if non-nil, zero value otherwise.

### GetContactUserOk

`func (o *BTExternalConnectionInfoAllOf) GetContactUserOk() (*BTUserSummaryInfo, bool)`
...
`func (o *BTExternalConnectionInfoAllOf) SetContactUser(v BTUserSummaryInfo)`

SetContactUser sets ContactUser field to given value.

### HasContactUser

`func (o *BTExternalConnectionInfoAllOf) HasContactUser() bool`
...
`func (o *BTExternalConnectionInfoAllOf) GetInvitedCompany() BTCompanySummaryInfo`

GetInvitedCompany returns the InvitedCompany field if non-nil, zero value otherwise.

### GetInvitedCompanyOk

`func (o *BTExternalConnectionInfoAllOf) GetInvitedCompanyOk() (*BTCompanySummaryInfo, bool)`
...
`func (o *BTExternalConnectionInfoAllOf) SetInvitedCompany(v BTCompanySummaryInfo)`

SetInvitedCompany sets InvitedCompany field to given value.

### HasInvitedCompany

`func (o *BTExternalConnectionInfoAllOf) HasInvitedCompany() bool`

HasInvitedCompany returns a boolean if a field has been set.

### GetIsOwnerEnterpriseEdu

`func (o *BTExternalConnectionInfoAllOf) GetIsOwnerEnterpriseEdu() bool`

GetIsOwnerEnterpriseEdu returns the IsOwnerEnterpriseEdu field if non-nil, zero value otherwise.

### GetIsOwnerEnterpriseEduOk

`func (o *BTExternalConnectionInfoAllOf) GetIsOwnerEnterpriseEduOk() (*bool, bool)`
...
`func (o *BTExternalConnectionInfoAllOf) SetIsOwnerEnterpriseEdu(v bool)`

SetIsOwnerEnterpriseEdu sets IsOwnerEnterpriseEdu field to given value.

### HasIsOwnerEnterpriseEdu

`func (o *BTExternalConnectionInfoAllOf) HasIsOwnerEnterpriseEdu() bool`
...
`func (o *BTExternalConnectionInfoAllOf) GetNumberOfMembers() int64`

GetNumberOfMembers returns the NumberOfMembers field if non-nil, zero value otherwise.

### GetNumberOfMembersOk

`func (o *BTExternalConnectionInfoAllOf) GetNumberOfMembersOk() (*int64, bool)`
...
`func (o *BTExternalConnectionInfoAllOf) SetNumberOfMembers(v int64)`

SetNumberOfMembers sets NumberOfMembers field to given value.

### HasNumberOfMembers

`func (o *BTExternalConnectionInfoAllOf) HasNumberOfMembers() bool`
