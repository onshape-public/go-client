...
**NumberHorizontalZones** | Pointer to **int32** | The number of horizontal zones to include in the drawing&#39;s graphics area. | [optional] [default to 0]
**NumberVerticalZones** | Pointer to **int32** | The number of vertical zones to include in the drawing&#39;s graphics area. | [optional] [default to 0]
