...
func (r ApiGetPartMetadataRequest) Execute() (*BTPartMetadataInfo, *http.Response, error) {
	return r.ApiService.GetPartMetadataExecute(r)
}
...
*/
func (a *PartApiService) GetPartMetadata(ctx context.Context, did string, wvm string, wvmid string, eid string, partid string) ApiGetPartMetadataRequest {
	return ApiGetPartMetadataRequest{
		ApiService: a,
		ctx:        ctx,
		did:        did,
...
func (a *PartApiService) GetPartMetadataExecute(r ApiGetPartMetadataRequest) (*BTPartMetadataInfo, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PartApiService.GetPartMetadata")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/parts/d/{did}/{wvm}/{wvmid}/e/{eid}/partid/{partid}/metadata"
	localVarPath = strings.Replace(localVarPath, "{"+"did"+"}", url.PathEscape(parameterToString(r.did, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"wvm"+"}", url.PathEscape(parameterToString(r.wvm, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"wvmid"+"}", url.PathEscape(parameterToString(r.wvmid, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"eid"+"}", url.PathEscape(parameterToString(r.eid, "")), -1)
...
func (r ApiGetStandardContentPartMetadataRequest) Execute() (*BTPartMetadataInfo, *http.Response, error) {
	return r.ApiService.GetStandardContentPartMetadataExecute(r)
}
...
*/
func (a *PartApiService) GetStandardContentPartMetadata(ctx context.Context, did string, vid string, eid string, otype string, oid string, partid string) ApiGetStandardContentPartMetadataRequest {
	return ApiGetStandardContentPartMetadataRequest{
		ApiService: a,
		ctx:        ctx,
		did:        did,
...
// Execute executes the request
//  @return BTPartMetadataInfo
func (a *PartApiService) GetStandardContentPartMetadataExecute(r ApiGetStandardContentPartMetadataRequest) (*BTPartMetadataInfo, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PartApiService.GetStandardContentPartMetadata")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/parts/standardcontent/d/{did}/v/{vid}/e/{eid}/{otype}/{oid}/partid/{partid}/metadata"
	localVarPath = strings.Replace(localVarPath, "{"+"did"+"}", url.PathEscape(parameterToString(r.did, "")), -1)
...
func (r ApiUpdatePartMetadataRequest) Execute() (*BTPartMetadataInfo, *http.Response, error) {
	return r.ApiService.UpdatePartMetadataExecute(r)
}
...
*/
func (a *PartApiService) UpdatePartMetadata(ctx context.Context, did string, wvm string, wvmid string, eid string, partid string) ApiUpdatePartMetadataRequest {
	return ApiUpdatePartMetadataRequest{
		ApiService: a,
		ctx:        ctx,
		did:        did,
...
// Execute executes the request
//  @return BTPartMetadataInfo
func (a *PartApiService) UpdatePartMetadataExecute(r ApiUpdatePartMetadataRequest) (*BTPartMetadataInfo, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PartApiService.UpdatePartMetadata")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateStandardContentPartMetadataRequest) Execute() (*BTPartMetadataInfo, *http.Response, error) {
	return r.ApiService.UpdateStandardContentPartMetadataExecute(r)
}
...
*/
func (a *PartApiService) UpdateStandardContentPartMetadata(ctx context.Context, did string, vid string, eid string, otype string, oid string, partid string) ApiUpdateStandardContentPartMetadataRequest {
	return ApiUpdateStandardContentPartMetadataRequest{
		ApiService: a,
		ctx:        ctx,
		did:        did,
...
// Execute executes the request
//  @return BTPartMetadataInfo
func (a *PartApiService) UpdateStandardContentPartMetadataExecute(r ApiUpdateStandardContentPartMetadataRequest) (*BTPartMetadataInfo, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PartApiService.UpdateStandardContentPartMetadata")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
