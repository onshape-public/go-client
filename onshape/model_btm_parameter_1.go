...
// BTMParameterNotice4455AsBTMParameter1 is a convenience function that returns BTMParameterNotice4455 wrapped in BTMParameter1
func (o *BTMParameterNotice4455) AsBTMParameter1() *BTMParameter1 {
	return &BTMParameter1{o}
}
...
func (dst *BTMParameter1) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["btType"] == "BTMParameterNotice-4455" {
		...
		if err == nil {
			...
			dst.implBTMParameter1 = nil
			return fmt.Errorf("failed to unmarshal BTMParameter1 as BTMParameterNotice4455: %s", err.Error())
		}
	}
...
// GetParameterName returns the ParameterName field value if set, zero value otherwise.
func (o *base_BTMParameter1) GetParameterName() string {
...
// GetParameterNameOk returns a tuple with the ParameterName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTMParameter1) GetParameterNameOk() (*string, bool) {
	if o == nil || o.ParameterName == nil {
		return nil, false
	}
...
// HasParameterName returns a boolean if a field has been set.
func (o *base_BTMParameter1) HasParameterName() bool {
	if o != nil && o.ParameterName != nil {
		return true
	}
...
// SetParameterName gets a reference to the given string and assigns it to the ParameterName field.
func (o *base_BTMParameter1) SetParameterName(v string) {
	o.ParameterName = &v
}
