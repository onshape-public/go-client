...
// BTMRigidFeature3076AsBTMSimulationFeature5034 is a convenience function that returns BTMRigidFeature3076 wrapped in BTMSimulationFeature5034
func (o *BTMRigidFeature3076) AsBTMSimulationFeature5034() *BTMSimulationFeature5034 {
	return &BTMSimulationFeature5034{o}
}
...
func (dst *BTMSimulationFeature5034) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'BTMRigidFeature-3076'
	if jsonDict["btType"] == "BTMRigidFeature-3076" {
		// try to unmarshal JSON data into BTMRigidFeature3076
		var qr *BTMRigidFeature3076
		err = json.Unmarshal(data, &qr)
		if err == nil {
			dst.implBTMSimulationFeature5034 = qr
			return nil // data stored, return on the first match
			...
			dst.implBTMSimulationFeature5034 = nil
			return fmt.Errorf("failed to unmarshal BTMSimulationFeature5034 as BTMRigidFeature3076: %s", err.Error())
		}
	}
