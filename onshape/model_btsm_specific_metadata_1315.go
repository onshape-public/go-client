...
type BTSMSpecificMetadata1315 struct {
	...
	DefinitionEntityType *string `json:"definitionEntityType,omitempty"`
}
...
// SetDefinitionEntityType gets a reference to the given string and assigns it to the DefinitionEntityType field.
