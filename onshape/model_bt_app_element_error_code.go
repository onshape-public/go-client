...
const (
	...
	TRANSACTION_CONFLICT BTAppElementErrorCode = "TRANSACTION_CONFLICT"
	NOT_FOUND            BTAppElementErrorCode = "NOT_FOUND"
	INCONSISTENT_CHANGES BTAppElementErrorCode = "INCONSISTENT_CHANGES"
)
