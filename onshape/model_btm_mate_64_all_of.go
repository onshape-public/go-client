...
func (o BTMMate64AllOf) MarshalJSON() ([]byte, error) {
...
type NullableBTMMate64AllOf struct {
	value *BTMMate64AllOf
	isSet bool
}

func (v NullableBTMMate64AllOf) Get() *BTMMate64AllOf {
	return v.value
}

func (v *NullableBTMMate64AllOf) Set(val *BTMMate64AllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBTMMate64AllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBTMMate64AllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTMMate64AllOf(val *BTMMate64AllOf) *NullableBTMMate64AllOf {
	return &NullableBTMMate64AllOf{value: val, isSet: true}
}

func (v NullableBTMMate64AllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTMMate64AllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
