...
func (o *BTPLValueBoxDereference251) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPLValueBoxDereference251) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPLValueBoxDereference251) SetDocumentationType(v string) {
