...
// BTListResponseBTTeamMemberInfo struct for BTListResponseBTTeamMemberInfo
type BTListResponseBTTeamMemberInfo struct {
	Href     *string            `json:"href,omitempty"`
	Items    []BTTeamMemberInfo `json:"items,omitempty"`
...
func NewBTListResponseBTTeamMemberInfo() *BTListResponseBTTeamMemberInfo {
	this := BTListResponseBTTeamMemberInfo{}
	return &this
}
...
// SetItems gets a reference to the given []BTTeamMemberInfo and assigns it to the Items field.
...
func (o BTListResponseBTTeamMemberInfo) MarshalJSON() ([]byte, error) {
...
type NullableBTListResponseBTTeamMemberInfo struct {
	value *BTListResponseBTTeamMemberInfo
	isSet bool
}

func (v NullableBTListResponseBTTeamMemberInfo) Get() *BTListResponseBTTeamMemberInfo {
	return v.value
}

func (v *NullableBTListResponseBTTeamMemberInfo) Set(val *BTListResponseBTTeamMemberInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableBTListResponseBTTeamMemberInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableBTListResponseBTTeamMemberInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTListResponseBTTeamMemberInfo(val *BTListResponseBTTeamMemberInfo) *NullableBTListResponseBTTeamMemberInfo {
	return &NullableBTListResponseBTTeamMemberInfo{value: val, isSet: true}
}

func (v NullableBTListResponseBTTeamMemberInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTListResponseBTTeamMemberInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
