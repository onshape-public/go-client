...
// CustomerSubscriptionCollection struct for CustomerSubscriptionCollection
type CustomerSubscriptionCollection struct {
...
func NewCustomerSubscriptionCollection() *CustomerSubscriptionCollection {
	this := CustomerSubscriptionCollection{}
	return &this
}
...
func (o CustomerSubscriptionCollection) MarshalJSON() ([]byte, error) {
...
type NullableCustomerSubscriptionCollection struct {
	value *CustomerSubscriptionCollection
	isSet bool
}

func (v NullableCustomerSubscriptionCollection) Get() *CustomerSubscriptionCollection {
	return v.value
}

func (v *NullableCustomerSubscriptionCollection) Set(val *CustomerSubscriptionCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerSubscriptionCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerSubscriptionCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerSubscriptionCollection(val *CustomerSubscriptionCollection) *NullableCustomerSubscriptionCollection {
	return &NullableCustomerSubscriptionCollection{value: val, isSet: true}
}

func (v NullableCustomerSubscriptionCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerSubscriptionCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
