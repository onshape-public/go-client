...
// BTPFunctionDeclaration246AsBTPNode7 is a convenience function that returns BTPFunctionDeclaration246 wrapped in BTPNode7
func (o *BTPFunctionDeclaration246) AsBTPNode7() *BTPNode7 {
	return &BTPNode7{o}
}
...
func (dst *BTPNode7) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["btType"] == "BTPFunctionDeclaration-246" {
		...
		if err == nil {
			...
			dst.implBTPNode7 = nil
			return fmt.Errorf("Failed to unmarshal BTPNode7 as BTPFunctionDeclaration246: %s", err.Error())
		}
	}
