...
// GetLibraryRelationType returns the LibraryRelationType field value if set, zero value otherwise.
func (o *base_BTMParameterReferenceWithConfiguration3028) GetLibraryRelationType() GBTParameterLibraryRelationType {
...
// GetLibraryRelationTypeOk returns a tuple with the LibraryRelationType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTMParameterReferenceWithConfiguration3028) GetLibraryRelationTypeOk() (*GBTParameterLibraryRelationType, bool) {
	if o == nil || o.LibraryRelationType == nil {
		return nil, false
	}
...
// HasLibraryRelationType returns a boolean if a field has been set.
func (o *base_BTMParameterReferenceWithConfiguration3028) HasLibraryRelationType() bool {
	if o != nil && o.LibraryRelationType != nil {
		return true
	}
...
// SetLibraryRelationType gets a reference to the given GBTParameterLibraryRelationType and assigns it to the LibraryRelationType field.
func (o *base_BTMParameterReferenceWithConfiguration3028) SetLibraryRelationType(v GBTParameterLibraryRelationType) {
	o.LibraryRelationType = &v
}

// GetMicroversionId returns the MicroversionId field value if set, zero value otherwise.
func (o *base_BTMParameterReferenceWithConfiguration3028) GetMicroversionId() string {
...
// GetMicroversionIdOk returns a tuple with the MicroversionId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTMParameterReferenceWithConfiguration3028) GetMicroversionIdOk() (*string, bool) {
	if o == nil || o.MicroversionId == nil {
		return nil, false
	}
...
// HasMicroversionId returns a boolean if a field has been set.
func (o *base_BTMParameterReferenceWithConfiguration3028) HasMicroversionId() bool {
	if o != nil && o.MicroversionId != nil {
		return true
	}
...
// SetMicroversionId gets a reference to the given string and assigns it to the MicroversionId field.
func (o *base_BTMParameterReferenceWithConfiguration3028) SetMicroversionId(v string) {
	o.MicroversionId = &v
}
...
// GetParameterName returns the ParameterName field value if set, zero value otherwise.
func (o *base_BTMParameterReferenceWithConfiguration3028) GetParameterName() string {
...
// GetParameterNameOk returns a tuple with the ParameterName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTMParameterReferenceWithConfiguration3028) GetParameterNameOk() (*string, bool) {
	if o == nil || o.ParameterName == nil {
		return nil, false
	}
...
// HasParameterName returns a boolean if a field has been set.
func (o *base_BTMParameterReferenceWithConfiguration3028) HasParameterName() bool {
	if o != nil && o.ParameterName != nil {
		return true
	}
...
// SetParameterName gets a reference to the given string and assigns it to the ParameterName field.
func (o *base_BTMParameterReferenceWithConfiguration3028) SetParameterName(v string) {
	o.ParameterName = &v
}
