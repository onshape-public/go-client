...
// BTStandardContentPropertyIdAndValue Non-driving custom parameters whose values are to be set.
type BTStandardContentPropertyIdAndValue struct {
...
func NewBTStandardContentPropertyIdAndValue() *BTStandardContentPropertyIdAndValue {
	this := BTStandardContentPropertyIdAndValue{}
	return &this
}
...
func (o BTStandardContentPropertyIdAndValue) MarshalJSON() ([]byte, error) {
...
type NullableBTStandardContentPropertyIdAndValue struct {
	value *BTStandardContentPropertyIdAndValue
	isSet bool
}

func (v NullableBTStandardContentPropertyIdAndValue) Get() *BTStandardContentPropertyIdAndValue {
	return v.value
}

func (v *NullableBTStandardContentPropertyIdAndValue) Set(val *BTStandardContentPropertyIdAndValue) {
	v.value = val
	v.isSet = true
}

func (v NullableBTStandardContentPropertyIdAndValue) IsSet() bool {
	return v.isSet
}

func (v *NullableBTStandardContentPropertyIdAndValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTStandardContentPropertyIdAndValue(val *BTStandardContentPropertyIdAndValue) *NullableBTStandardContentPropertyIdAndValue {
	return &NullableBTStandardContentPropertyIdAndValue{value: val, isSet: true}
}

func (v NullableBTStandardContentPropertyIdAndValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTStandardContentPropertyIdAndValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
