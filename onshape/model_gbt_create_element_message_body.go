...
// GBTCreateElementMessageBody struct for GBTCreateElementMessageBody
type GBTCreateElementMessageBody struct {
...
func NewGBTCreateElementMessageBody() *GBTCreateElementMessageBody {
	this := GBTCreateElementMessageBody{}
	return &this
}
...
func (o GBTCreateElementMessageBody) MarshalJSON() ([]byte, error) {
...
type NullableGBTCreateElementMessageBody struct {
	value *GBTCreateElementMessageBody
	isSet bool
}

func (v NullableGBTCreateElementMessageBody) Get() *GBTCreateElementMessageBody {
	return v.value
}

func (v *NullableGBTCreateElementMessageBody) Set(val *GBTCreateElementMessageBody) {
	v.value = val
	v.isSet = true
}

func (v NullableGBTCreateElementMessageBody) IsSet() bool {
	return v.isSet
}

func (v *NullableGBTCreateElementMessageBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGBTCreateElementMessageBody(val *GBTCreateElementMessageBody) *NullableGBTCreateElementMessageBody {
	return &NullableGBTCreateElementMessageBody{value: val, isSet: true}
}

func (v NullableGBTCreateElementMessageBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGBTCreateElementMessageBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
