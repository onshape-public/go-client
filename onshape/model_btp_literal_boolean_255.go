...
func (o *BTPLiteralBoolean255) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPLiteralBoolean255) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPLiteralBoolean255) SetDocumentationType(v string) {
