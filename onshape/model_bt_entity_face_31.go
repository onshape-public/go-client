...
func (o *BTEntityFace31) GetEdge() bool {
	type getResult interface {
		GetEdge() bool
	}
...
// and a boolean to check if the value has been set.
func (o *BTEntityFace31) GetEdgeOk() (*bool, bool) {
	type getResult interface {
		GetEdgeOk() (*bool, bool)
	}
...
func (o *BTEntityFace31) HasEdge() bool {
	type getResult interface {
		HasEdge() bool
	}
...
func (o *BTEntityFace31) SetEdge(v bool) {
	type getResult interface {
		SetEdge(v bool)
	}
...
func (o *BTEntityFace31) GetPoint() bool {
	type getResult interface {
		GetPoint() bool
	}
...
// and a boolean to check if the value has been set.
func (o *BTEntityFace31) GetPointOk() (*bool, bool) {
	type getResult interface {
...
func (o *BTEntityFace31) HasPoint() bool {
	type getResult interface {
		HasPoint() bool
	}
...
func (o *BTEntityFace31) SetPoint(v bool) {
	type getResult interface {
		SetPoint(v bool)
	}
...
// GetEdge returns the Edge field value if set, zero value otherwise.
func (o *base_BTEntityFace31) GetEdge() bool {
	if o == nil || o.Edge == nil {
		var ret bool
		return ret
	}
...
// GetEdgeOk returns a tuple with the Edge field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTEntityFace31) GetEdgeOk() (*bool, bool) {
	if o == nil || o.Edge == nil {
		return nil, false
	}
	return o.Edge, true
...
// HasEdge returns a boolean if a field has been set.
func (o *base_BTEntityFace31) HasEdge() bool {
	if o != nil && o.Edge != nil {
		return true
	}
...
// SetEdge gets a reference to the given bool and assigns it to the Edge field.
func (o *base_BTEntityFace31) SetEdge(v bool) {
	o.Edge = &v
}
...
// GetPoint returns the Point field value if set, zero value otherwise.
func (o *base_BTEntityFace31) GetPoint() bool {
...
// GetPointOk returns a tuple with the Point field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTEntityFace31) GetPointOk() (*bool, bool) {
	if o == nil || o.Point == nil {
		return nil, false
	}
	return o.Point, true
...
// HasPoint returns a boolean if a field has been set.
func (o *base_BTEntityFace31) HasPoint() bool {
	if o != nil && o.Point != nil {
		return true
	}
...
// SetPoint gets a reference to the given bool and assigns it to the Point field.
func (o *base_BTEntityFace31) SetPoint(v bool) {
	o.Point = &v
}
