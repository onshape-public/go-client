...
func (o *BTParameterSpecQuantity173) GetEnumOptions() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecQuantity173) GetEnumOptionsOk() ([]string, bool) {
	if o == nil || o.EnumOptions == nil {
		return nil, false
	}
...
func (o *BTParameterSpecQuantity173) HasEnumOptions() bool {
	if o != nil && o.EnumOptions != nil {
		return true
	}
...
func (o *BTParameterSpecQuantity173) SetEnumOptions(v []string) {
	o.EnumOptions = v
}
