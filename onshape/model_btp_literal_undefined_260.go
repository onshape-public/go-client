...
func (o *BTPLiteralUndefined260) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPLiteralUndefined260) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPLiteralUndefined260) SetDocumentationType(v string) {
