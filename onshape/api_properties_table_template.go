...
func (r ApiGetByCompanyIdRequest) TemplateType(templateType string) ApiGetByCompanyIdRequest {
...
// Indicates filter for table templates: 0 (BOM) or 1 (Revision Table).
func (r ApiGetByDocumentIdRequest) TemplateType(templateType string) ApiGetByDocumentIdRequest {
	r.templateType = &templateType
	return r
}
