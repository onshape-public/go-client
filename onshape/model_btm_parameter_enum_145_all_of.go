...
func (o BTMParameterEnum145AllOf) MarshalJSON() ([]byte, error) {
...
type NullableBTMParameterEnum145AllOf struct {
	value *BTMParameterEnum145AllOf
	isSet bool
}

func (v NullableBTMParameterEnum145AllOf) Get() *BTMParameterEnum145AllOf {
	return v.value
}

func (v *NullableBTMParameterEnum145AllOf) Set(val *BTMParameterEnum145AllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBTMParameterEnum145AllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBTMParameterEnum145AllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTMParameterEnum145AllOf(val *BTMParameterEnum145AllOf) *NullableBTMParameterEnum145AllOf {
	return &NullableBTMParameterEnum145AllOf{value: val, isSet: true}
}

func (v NullableBTMParameterEnum145AllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTMParameterEnum145AllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
