...
// BTListResponseBTPurchaseInfo A list of resources that typically supports paging.
type BTListResponseBTPurchaseInfo struct {
	// URI for current page of resources.
	Href *string `json:"href,omitempty"`
	// Array of items in the current page.
	Items []BTPurchaseInfo `json:"items,omitempty"`
...
func NewBTListResponseBTPurchaseInfo() *BTListResponseBTPurchaseInfo {
	this := BTListResponseBTPurchaseInfo{}
	return &this
}
...
// SetItems gets a reference to the given []BTPurchaseInfo and assigns it to the Items field.
...
func (o BTListResponseBTPurchaseInfo) MarshalJSON() ([]byte, error) {
...
type NullableBTListResponseBTPurchaseInfo struct {
	value *BTListResponseBTPurchaseInfo
	isSet bool
}

func (v NullableBTListResponseBTPurchaseInfo) Get() *BTListResponseBTPurchaseInfo {
	return v.value
}

func (v *NullableBTListResponseBTPurchaseInfo) Set(val *BTListResponseBTPurchaseInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableBTListResponseBTPurchaseInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableBTListResponseBTPurchaseInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTListResponseBTPurchaseInfo(val *BTListResponseBTPurchaseInfo) *NullableBTListResponseBTPurchaseInfo {
	return &NullableBTListResponseBTPurchaseInfo{value: val, isSet: true}
}

func (v NullableBTListResponseBTPurchaseInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTListResponseBTPurchaseInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
