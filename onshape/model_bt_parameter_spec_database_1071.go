...
func (o *BTParameterSpecDatabase1071) GetUiHints() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecDatabase1071) GetUiHintsOk() ([]string, bool) {
	if o == nil || o.UiHints == nil {
		return nil, false
	}
...
func (o *BTParameterSpecDatabase1071) SetUiHints(v []string) {
	o.UiHints = v
}
