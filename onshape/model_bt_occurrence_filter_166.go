...
func (o *BTOccurrenceFilter166) GetExcludeParametricPartStudioChildInstance() bool {
	if o == nil || o.ExcludeParametricPartStudioChildInstance == nil {
		var ret bool
		return ret
	}
	return *o.ExcludeParametricPartStudioChildInstance
}

// GetExcludeParametricPartStudioChildInstanceOk returns a tuple with the ExcludeParametricPartStudioChildInstance field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BTOccurrenceFilter166) GetExcludeParametricPartStudioChildInstanceOk() (*bool, bool) {
	if o == nil || o.ExcludeParametricPartStudioChildInstance == nil {
		return nil, false
	}
	return o.ExcludeParametricPartStudioChildInstance, true
}
...
// SetExcludeParametricPartStudioChildInstance gets a reference to the given bool and assigns it to the ExcludeParametricPartStudioChildInstance field.
func (o *BTOccurrenceFilter166) SetExcludeParametricPartStudioChildInstance(v bool) {
	o.ExcludeParametricPartStudioChildInstance = &v
}
