...
func (o *BTParameterSpecStringWithTolerances2535) GetUiHints() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecStringWithTolerances2535) GetUiHintsOk() ([]string, bool) {
	if o == nil || o.UiHints == nil {
		return nil, false
	}
...
func (o *BTParameterSpecStringWithTolerances2535) SetUiHints(v []string) {
	o.UiHints = v
}
