...
func (o *BTParameterSpecStringWithTolerances2535) GetEnumOptions() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecStringWithTolerances2535) GetEnumOptionsOk() ([]string, bool) {
	if o == nil || o.EnumOptions == nil {
		return nil, false
	}
...
func (o *BTParameterSpecStringWithTolerances2535) HasEnumOptions() bool {
	if o != nil && o.EnumOptions != nil {
		return true
	}
...
func (o *BTParameterSpecStringWithTolerances2535) SetEnumOptions(v []string) {
	o.EnumOptions = v
}
