...
func (o *BTPStatementBreak272) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPStatementBreak272) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPStatementBreak272) SetDocumentationType(v string) {
