...
func (o *BTParameterSpecReferenceImage1722) GetUiHints() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecReferenceImage1722) GetUiHintsOk() ([]string, bool) {
	if o == nil || o.UiHints == nil {
		return nil, false
	}
...
func (o *BTParameterSpecReferenceImage1722) SetUiHints(v []string) {
	o.UiHints = v
}
