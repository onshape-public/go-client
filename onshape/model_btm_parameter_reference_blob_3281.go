...
func (o *BTMParameterReferenceBlob3281) GetParameterName() string {
	type getResult interface {
...
// and a boolean to check if the value has been set.
func (o *BTMParameterReferenceBlob3281) GetParameterNameOk() (*string, bool) {
	type getResult interface {
...
func (o *BTMParameterReferenceBlob3281) HasParameterName() bool {
	type getResult interface {
...
func (o *BTMParameterReferenceBlob3281) SetParameterName(v string) {
	type getResult interface {
...
// GetParameterName returns the ParameterName field value if set, zero value otherwise.
func (o *base_BTMParameterReferenceBlob3281) GetParameterName() string {
...
// GetParameterNameOk returns a tuple with the ParameterName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTMParameterReferenceBlob3281) GetParameterNameOk() (*string, bool) {
	if o == nil || o.ParameterName == nil {
		return nil, false
	}
...
// HasParameterName returns a boolean if a field has been set.
func (o *base_BTMParameterReferenceBlob3281) HasParameterName() bool {
	if o != nil && o.ParameterName != nil {
		return true
	}
...
// SetParameterName gets a reference to the given string and assigns it to the ParameterName field.
func (o *base_BTMParameterReferenceBlob3281) SetParameterName(v string) {
	o.ParameterName = &v
}
