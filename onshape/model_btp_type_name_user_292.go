...
func (o *BTPTypeNameUser292) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPTypeNameUser292) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPTypeNameUser292) SetDocumentationType(v string) {
