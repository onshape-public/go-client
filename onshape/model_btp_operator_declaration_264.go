...
func (o *BTPOperatorDeclaration264) GetTopLevelType() GBTPDefinitionType {
...
// and a boolean to check if the value has been set.
func (o *BTPOperatorDeclaration264) GetTopLevelTypeOk() (*GBTPDefinitionType, bool) {
	if o == nil || o.TopLevelType == nil {
		return nil, false
	}
...
func (o *BTPOperatorDeclaration264) HasTopLevelType() bool {
	if o != nil && o.TopLevelType != nil {
		return true
	}
...
func (o *BTPOperatorDeclaration264) SetTopLevelType(v GBTPDefinitionType) {
	o.TopLevelType = &v
}
