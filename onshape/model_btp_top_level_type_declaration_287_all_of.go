...
func NewBTPTopLevelTypeDeclaration287AllOf() *BTPTopLevelTypeDeclaration287AllOf {
	this := BTPTopLevelTypeDeclaration287AllOf{}
	return &this
}
...
func (o BTPTopLevelTypeDeclaration287AllOf) MarshalJSON() ([]byte, error) {
...
type NullableBTPTopLevelTypeDeclaration287AllOf struct {
	value *BTPTopLevelTypeDeclaration287AllOf
	isSet bool
}

func (v NullableBTPTopLevelTypeDeclaration287AllOf) Get() *BTPTopLevelTypeDeclaration287AllOf {
	return v.value
}

func (v *NullableBTPTopLevelTypeDeclaration287AllOf) Set(val *BTPTopLevelTypeDeclaration287AllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBTPTopLevelTypeDeclaration287AllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBTPTopLevelTypeDeclaration287AllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTPTopLevelTypeDeclaration287AllOf(val *BTPTopLevelTypeDeclaration287AllOf) *NullableBTPTopLevelTypeDeclaration287AllOf {
	return &NullableBTPTopLevelTypeDeclaration287AllOf{value: val, isSet: true}
}

func (v NullableBTPTopLevelTypeDeclaration287AllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTPTopLevelTypeDeclaration287AllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
