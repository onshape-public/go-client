...
// BTWhereUsedItemInfoList struct for BTWhereUsedItemInfoList
type BTWhereUsedItemInfoList struct {
	// The resolved default configuration parameters for the queried element. Only populated when the configuration query parameter is set to 'default'.
	DefaultConfig []ConfigInfo `json:"defaultConfig,omitempty"`
	// URI for current page of resources.
	Href *string `json:"href,omitempty"`
	// Array of items in the current page.
	Items []BTProductStructureItemInfo `json:"items,omitempty"`
	// URI for next page of the resources if more are available.
	Next *string `json:"next,omitempty"`
	// URI for previous page of the resources.
	Previous *string `json:"previous,omitempty"`
	// List of document versions in which the queried item is referenced. Each entry contains the version info, referring document and element details, configuration, revision, and part identifiers. Only populated when includeVersionInfo is true.
	Versions []BTWhereUsedVersionReferencedInfo `json:"versions,omitempty"`
}
...
// SetDefaultConfig gets a reference to the given []ConfigInfo and assigns it to the DefaultConfig field.
...
func (o *BTWhereUsedItemInfoList) GetItems() []BTProductStructureItemInfo {
	if o == nil || o.Items == nil {
		var ret []BTProductStructureItemInfo
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []BTProductStructureItemInfo and assigns it to the Items field.
...
func (o *BTWhereUsedItemInfoList) GetVersions() []BTWhereUsedVersionReferencedInfo {
	if o == nil || o.Versions == nil {
		var ret []BTWhereUsedVersionReferencedInfo
		return ret
	}
	return o.Versions
}
...
// SetVersions gets a reference to the given []BTWhereUsedVersionReferencedInfo and assigns it to the Versions field.
func (o *BTWhereUsedItemInfoList) SetVersions(v []BTWhereUsedVersionReferencedInfo) {
	o.Versions = v
}

func (o BTWhereUsedItemInfoList) MarshalJSON() ([]byte, error) {
...
type NullableBTWhereUsedItemInfoList struct {
	value *BTWhereUsedItemInfoList
	isSet bool
}

func (v NullableBTWhereUsedItemInfoList) Get() *BTWhereUsedItemInfoList {
	return v.value
}

func (v *NullableBTWhereUsedItemInfoList) Set(val *BTWhereUsedItemInfoList) {
	v.value = val
	v.isSet = true
}

func (v NullableBTWhereUsedItemInfoList) IsSet() bool {
	return v.isSet
}

func (v *NullableBTWhereUsedItemInfoList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTWhereUsedItemInfoList(val *BTWhereUsedItemInfoList) *NullableBTWhereUsedItemInfoList {
	return &NullableBTWhereUsedItemInfoList{value: val, isSet: true}
}

func (v NullableBTWhereUsedItemInfoList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTWhereUsedItemInfoList) UnmarshalJSON(src []byte) error {
	v.isSet = true
