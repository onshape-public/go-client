...
func (o *BTParameterSpecMaterial2700) GetUiHints() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecMaterial2700) GetUiHintsOk() ([]string, bool) {
	if o == nil || o.UiHints == nil {
		return nil, false
	}
...
func (o *BTParameterSpecMaterial2700) SetUiHints(v []string) {
	o.UiHints = v
}
