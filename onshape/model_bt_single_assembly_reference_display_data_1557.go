...
type BTSingleAssemblyReferenceDisplayData1557 struct {
	...
	NamedPositionIdsAndNames *map[string]string           `json:"namedPositionIdsAndNames,omitempty"`
...
// GetNamedPositionIdsAndNames returns the NamedPositionIdsAndNames field value if set, zero value otherwise.
func (o *BTSingleAssemblyReferenceDisplayData1557) GetNamedPositionIdsAndNames() map[string]string {
	if o == nil || o.NamedPositionIdsAndNames == nil {
		var ret map[string]string
		return ret
	}
	return *o.NamedPositionIdsAndNames
}

// GetNamedPositionIdsAndNamesOk returns a tuple with the NamedPositionIdsAndNames field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BTSingleAssemblyReferenceDisplayData1557) GetNamedPositionIdsAndNamesOk() (*map[string]string, bool) {
	if o == nil || o.NamedPositionIdsAndNames == nil {
		return nil, false
	}
	return o.NamedPositionIdsAndNames, true
}

// HasNamedPositionIdsAndNames returns a boolean if a field has been set.
func (o *BTSingleAssemblyReferenceDisplayData1557) HasNamedPositionIdsAndNames() bool {
	if o != nil && o.NamedPositionIdsAndNames != nil {
		return true
	}
...
// SetNamedPositionIdsAndNames gets a reference to the given map[string]string and assigns it to the NamedPositionIdsAndNames field.
func (o *BTSingleAssemblyReferenceDisplayData1557) SetNamedPositionIdsAndNames(v map[string]string) {
	o.NamedPositionIdsAndNames = &v
}
...
func (o BTSingleAssemblyReferenceDisplayData1557) MarshalJSON() ([]byte, error) {
	...
	if o.NamedPositionIdsAndNames != nil {
		toSerialize["namedPositionIdsAndNames"] = o.NamedPositionIdsAndNames
	}
