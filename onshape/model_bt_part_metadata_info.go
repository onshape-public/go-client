...
func (o *BTPartMetadataInfo) GetCustomPropertyDefinitions() map[string]BTCustomPropertyDefinitionInfo {
	if o == nil || o.CustomPropertyDefinitions == nil {
		var ret map[string]BTCustomPropertyDefinitionInfo
		return ret
	}
...
// SetCustomPropertyDefinitions gets a reference to the given map[string]BTCustomPropertyDefinitionInfo and assigns it to the CustomPropertyDefinitions field.
