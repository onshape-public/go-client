...
func (o *BTParameterSpecBoolean170) GetEnumOptions() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecBoolean170) GetEnumOptionsOk() ([]string, bool) {
	if o == nil || o.EnumOptions == nil {
		return nil, false
	}
...
func (o *BTParameterSpecBoolean170) HasEnumOptions() bool {
	if o != nil && o.EnumOptions != nil {
		return true
	}
...
func (o *BTParameterSpecBoolean170) SetEnumOptions(v []string) {
	o.EnumOptions = v
}
