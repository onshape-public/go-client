...
func (o *BTParameterSpecBoolean170) GetUiHints() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecBoolean170) GetUiHintsOk() ([]string, bool) {
	if o == nil || o.UiHints == nil {
		return nil, false
	}
...
func (o *BTParameterSpecBoolean170) SetUiHints(v []string) {
	o.UiHints = v
}
