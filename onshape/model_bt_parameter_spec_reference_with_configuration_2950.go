...
func (o *BTParameterSpecReferenceWithConfiguration2950) GetUiHints() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecReferenceWithConfiguration2950) GetUiHintsOk() ([]string, bool) {
	if o == nil || o.UiHints == nil {
		return nil, false
	}
...
func (o *BTParameterSpecReferenceWithConfiguration2950) SetUiHints(v []string) {
	o.UiHints = v
}
