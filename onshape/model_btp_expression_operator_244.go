...
func (o *BTPExpressionOperator244) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPExpressionOperator244) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPExpressionOperator244) SetDocumentationType(v string) {
