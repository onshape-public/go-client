...
func (o RequestBodyContent) MarshalJSON() ([]byte, error) {
...
func (v NullableRequestBodyContent) Get() *RequestBodyContent {
	return v.value
}

func (v *NullableRequestBodyContent) Set(val *RequestBodyContent) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestBodyContent) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestBodyContent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestBodyContent(val *RequestBodyContent) *NullableRequestBodyContent {
	return &NullableRequestBodyContent{value: val, isSet: true}
}

func (v NullableRequestBodyContent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestBodyContent) UnmarshalJSON(src []byte) error {
	v.isSet = true
