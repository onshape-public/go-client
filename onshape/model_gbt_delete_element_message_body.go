...
// GBTDeleteElementMessageBody struct for GBTDeleteElementMessageBody
type GBTDeleteElementMessageBody struct {
...
func NewGBTDeleteElementMessageBody() *GBTDeleteElementMessageBody {
	this := GBTDeleteElementMessageBody{}
	return &this
}
...
func (o GBTDeleteElementMessageBody) MarshalJSON() ([]byte, error) {
...
type NullableGBTDeleteElementMessageBody struct {
	value *GBTDeleteElementMessageBody
	isSet bool
}

func (v NullableGBTDeleteElementMessageBody) Get() *GBTDeleteElementMessageBody {
	return v.value
}

func (v *NullableGBTDeleteElementMessageBody) Set(val *GBTDeleteElementMessageBody) {
	v.value = val
	v.isSet = true
}

func (v NullableGBTDeleteElementMessageBody) IsSet() bool {
	return v.isSet
}

func (v *NullableGBTDeleteElementMessageBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGBTDeleteElementMessageBody(val *GBTDeleteElementMessageBody) *NullableGBTDeleteElementMessageBody {
	return &NullableGBTDeleteElementMessageBody{value: val, isSet: true}
}

func (v NullableGBTDeleteElementMessageBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGBTDeleteElementMessageBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
