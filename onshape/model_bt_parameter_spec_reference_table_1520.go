...
func (o *BTParameterSpecReferenceTable1520) GetUiHints() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecReferenceTable1520) GetUiHintsOk() ([]string, bool) {
	if o == nil || o.UiHints == nil {
		return nil, false
	}
...
func (o *BTParameterSpecReferenceTable1520) SetUiHints(v []string) {
	o.UiHints = v
}
