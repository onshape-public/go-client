...
func NewBTUpdateFeaturesResponse1333() *BTUpdateFeaturesResponse1333 {
	this := BTUpdateFeaturesResponse1333{}
	return &this
}
...
func (o BTUpdateFeaturesResponse1333) MarshalJSON() ([]byte, error) {
...
type NullableBTUpdateFeaturesResponse1333 struct {
	value *BTUpdateFeaturesResponse1333
	isSet bool
}

func (v NullableBTUpdateFeaturesResponse1333) Get() *BTUpdateFeaturesResponse1333 {
	return v.value
}

func (v *NullableBTUpdateFeaturesResponse1333) Set(val *BTUpdateFeaturesResponse1333) {
	v.value = val
	v.isSet = true
}

func (v NullableBTUpdateFeaturesResponse1333) IsSet() bool {
	return v.isSet
}

func (v *NullableBTUpdateFeaturesResponse1333) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTUpdateFeaturesResponse1333(val *BTUpdateFeaturesResponse1333) *NullableBTUpdateFeaturesResponse1333 {
	return &NullableBTUpdateFeaturesResponse1333{value: val, isSet: true}
}

func (v NullableBTUpdateFeaturesResponse1333) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTUpdateFeaturesResponse1333) UnmarshalJSON(src []byte) error {
	v.isSet = true
