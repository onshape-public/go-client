...
// BTListResponseBTCategoryPropertyInfo struct for BTListResponseBTCategoryPropertyInfo
type BTListResponseBTCategoryPropertyInfo struct {
	Href     *string                  `json:"href,omitempty"`
	Items    []BTCategoryPropertyInfo `json:"items,omitempty"`
...
func NewBTListResponseBTCategoryPropertyInfo() *BTListResponseBTCategoryPropertyInfo {
	this := BTListResponseBTCategoryPropertyInfo{}
	return &this
}
...
func (o *BTListResponseBTCategoryPropertyInfo) GetItems() []BTCategoryPropertyInfo {
	if o == nil || o.Items == nil {
		var ret []BTCategoryPropertyInfo
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []BTCategoryPropertyInfo and assigns it to the Items field.
...
func (o BTListResponseBTCategoryPropertyInfo) MarshalJSON() ([]byte, error) {
...
type NullableBTListResponseBTCategoryPropertyInfo struct {
	value *BTListResponseBTCategoryPropertyInfo
	isSet bool
}

func (v NullableBTListResponseBTCategoryPropertyInfo) Get() *BTListResponseBTCategoryPropertyInfo {
	return v.value
}

func (v *NullableBTListResponseBTCategoryPropertyInfo) Set(val *BTListResponseBTCategoryPropertyInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableBTListResponseBTCategoryPropertyInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableBTListResponseBTCategoryPropertyInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTListResponseBTCategoryPropertyInfo(val *BTListResponseBTCategoryPropertyInfo) *NullableBTListResponseBTCategoryPropertyInfo {
	return &NullableBTListResponseBTCategoryPropertyInfo{value: val, isSet: true}
}

func (v NullableBTListResponseBTCategoryPropertyInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTListResponseBTCategoryPropertyInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
