...
func NewBTConfiguredValuesColumnInfo1025AllOf() *BTConfiguredValuesColumnInfo1025AllOf {
	this := BTConfiguredValuesColumnInfo1025AllOf{}
	return &this
}
...
func (o BTConfiguredValuesColumnInfo1025AllOf) MarshalJSON() ([]byte, error) {
...
type NullableBTConfiguredValuesColumnInfo1025AllOf struct {
	value *BTConfiguredValuesColumnInfo1025AllOf
	isSet bool
}

func (v NullableBTConfiguredValuesColumnInfo1025AllOf) Get() *BTConfiguredValuesColumnInfo1025AllOf {
	return v.value
}

func (v *NullableBTConfiguredValuesColumnInfo1025AllOf) Set(val *BTConfiguredValuesColumnInfo1025AllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBTConfiguredValuesColumnInfo1025AllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBTConfiguredValuesColumnInfo1025AllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTConfiguredValuesColumnInfo1025AllOf(val *BTConfiguredValuesColumnInfo1025AllOf) *NullableBTConfiguredValuesColumnInfo1025AllOf {
	return &NullableBTConfiguredValuesColumnInfo1025AllOf{value: val, isSet: true}
}

func (v NullableBTConfiguredValuesColumnInfo1025AllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTConfiguredValuesColumnInfo1025AllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
