...
// BTListResponseBTCompanyUserInfo A list of resources that typically supports paging.
type BTListResponseBTCompanyUserInfo struct {
	// URI for current page of resources.
	Href *string `json:"href,omitempty"`
	// Array of items in the current page.
	Items []BTCompanyUserInfo `json:"items,omitempty"`
...
func NewBTListResponseBTCompanyUserInfo() *BTListResponseBTCompanyUserInfo {
	this := BTListResponseBTCompanyUserInfo{}
	return &this
}
...
// SetItems gets a reference to the given []BTCompanyUserInfo and assigns it to the Items field.
...
func (o BTListResponseBTCompanyUserInfo) MarshalJSON() ([]byte, error) {
...
type NullableBTListResponseBTCompanyUserInfo struct {
	value *BTListResponseBTCompanyUserInfo
	isSet bool
}

func (v NullableBTListResponseBTCompanyUserInfo) Get() *BTListResponseBTCompanyUserInfo {
	return v.value
}

func (v *NullableBTListResponseBTCompanyUserInfo) Set(val *BTListResponseBTCompanyUserInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableBTListResponseBTCompanyUserInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableBTListResponseBTCompanyUserInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTListResponseBTCompanyUserInfo(val *BTListResponseBTCompanyUserInfo) *NullableBTListResponseBTCompanyUserInfo {
	return &NullableBTListResponseBTCompanyUserInfo{value: val, isSet: true}
}

func (v NullableBTListResponseBTCompanyUserInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTListResponseBTCompanyUserInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
