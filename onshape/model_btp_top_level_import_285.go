...
func (o *BTPTopLevelImport285) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPTopLevelImport285) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPTopLevelImport285) SetDocumentationType(v string) {
