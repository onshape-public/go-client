...
func (o *BTParameterSpecFeatureList703) GetUiHints() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecFeatureList703) GetUiHintsOk() ([]string, bool) {
	if o == nil || o.UiHints == nil {
		return nil, false
	}
...
func (o *BTParameterSpecFeatureList703) SetUiHints(v []string) {
	o.UiHints = v
}
