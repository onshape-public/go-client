...
// and a boolean to check if the value has been set.
func (o *BTMAssemblyMirrorFeature3037) GetParameterLibrariesOk() ([]BTMParameter1, bool) {
	if o == nil || o.ParameterLibraries == nil {
		return nil, false
	}
...
func (o *BTMAssemblyMirrorFeature3037) SetParameterLibraries(v []BTMParameter1) {
...
func (o *BTMAssemblyMirrorFeature3037) GetParentSuppressed() bool {
...
// and a boolean to check if the value has been set.
func (o *BTMAssemblyMirrorFeature3037) GetParentSuppressedOk() (*bool, bool) {
	if o == nil || o.ParentSuppressed == nil {
		return nil, false
	}
...
func (o *BTMAssemblyMirrorFeature3037) HasParentSuppressed() bool {
	if o != nil && o.ParentSuppressed != nil {
		return true
	}
...
func (o *BTMAssemblyMirrorFeature3037) SetParentSuppressed(v bool) {
...
type NullableBTMAssemblyMirrorFeature3037 struct {
	value *BTMAssemblyMirrorFeature3037
	isSet bool
}

func (v NullableBTMAssemblyMirrorFeature3037) Get() *BTMAssemblyMirrorFeature3037 {
	return v.value
}

func (v *NullableBTMAssemblyMirrorFeature3037) Set(val *BTMAssemblyMirrorFeature3037) {
	v.value = val
	v.isSet = true
}

func (v NullableBTMAssemblyMirrorFeature3037) IsSet() bool {
	return v.isSet
}

func (v *NullableBTMAssemblyMirrorFeature3037) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTMAssemblyMirrorFeature3037(val *BTMAssemblyMirrorFeature3037) *NullableBTMAssemblyMirrorFeature3037 {
	return &NullableBTMAssemblyMirrorFeature3037{value: val, isSet: true}
}

func (v NullableBTMAssemblyMirrorFeature3037) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTMAssemblyMirrorFeature3037) UnmarshalJSON(src []byte) error {
	v.isSet = true
