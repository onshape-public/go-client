...
// BTOccurrenceEntity5720 struct for BTOccurrenceEntity5720
type BTOccurrenceEntity5720 struct {
	// Type of JSON object.
...
// NewBTOccurrenceEntity5720 instantiates a new BTOccurrenceEntity5720 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBTOccurrenceEntity5720() *BTOccurrenceEntity5720 {
	this := BTOccurrenceEntity5720{}
	return &this
}

// NewBTOccurrenceEntity5720WithDefaults instantiates a new BTOccurrenceEntity5720 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewBTOccurrenceEntity5720WithDefaults() *BTOccurrenceEntity5720 {
	this := BTOccurrenceEntity5720{}
	return &this
}

// GetBtType returns the BtType field value if set, zero value otherwise.
func (o *BTOccurrenceEntity5720) GetBtType() string {
...
func (o *BTOccurrenceEntity5720) GetBtTypeOk() (*string, bool) {
	if o == nil || o.BtType == nil {
		return nil, false
	}
...
func (o *BTOccurrenceEntity5720) HasBtType() bool {
	if o != nil && o.BtType != nil {
		return true
	}
...
func (o *BTOccurrenceEntity5720) SetBtType(v string) {
	o.BtType = &v
}

// GetDeterministicId returns the DeterministicId field value if set, zero value otherwise.
func (o *BTOccurrenceEntity5720) GetDeterministicId() string {
...
// and a boolean to check if the value has been set.
func (o *BTOccurrenceEntity5720) GetDeterministicIdOk() (*string, bool) {
	if o == nil || o.DeterministicId == nil {
		return nil, false
	}
...
func (o *BTOccurrenceEntity5720) HasDeterministicId() bool {
	if o != nil && o.DeterministicId != nil {
		return true
	}
...
func (o *BTOccurrenceEntity5720) SetDeterministicId(v string) {
	o.DeterministicId = &v
}

// GetOccurrence returns the Occurrence field value if set, zero value otherwise.
func (o *BTOccurrenceEntity5720) GetOccurrence() BTOccurrence74 {
...
// and a boolean to check if the value has been set.
func (o *BTOccurrenceEntity5720) GetOccurrenceOk() (*BTOccurrence74, bool) {
	if o == nil || o.Occurrence == nil {
		return nil, false
	}
...
func (o *BTOccurrenceEntity5720) HasOccurrence() bool {
	if o != nil && o.Occurrence != nil {
		return true
	}
...
func (o *BTOccurrenceEntity5720) SetOccurrence(v BTOccurrence74) {
	o.Occurrence = &v
}

func (o BTOccurrenceEntity5720) MarshalJSON() ([]byte, error) {
...
type NullableBTOccurrenceEntity5720 struct {
	value *BTOccurrenceEntity5720
	isSet bool
}

func (v NullableBTOccurrenceEntity5720) Get() *BTOccurrenceEntity5720 {
	return v.value
}

func (v *NullableBTOccurrenceEntity5720) Set(val *BTOccurrenceEntity5720) {
	v.value = val
	v.isSet = true
}

func (v NullableBTOccurrenceEntity5720) IsSet() bool {
	return v.isSet
}

func (v *NullableBTOccurrenceEntity5720) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTOccurrenceEntity5720(val *BTOccurrenceEntity5720) *NullableBTOccurrenceEntity5720 {
	return &NullableBTOccurrenceEntity5720{value: val, isSet: true}
}

func (v NullableBTOccurrenceEntity5720) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTOccurrenceEntity5720) UnmarshalJSON(src []byte) error {
	v.isSet = true
