...
func (o *BTMReadOnlyParameter3800) GetLibraryRelationType() GBTParameterLibraryRelationType {
	type getResult interface {
...
// and a boolean to check if the value has been set.
func (o *BTMReadOnlyParameter3800) GetLibraryRelationTypeOk() (*GBTParameterLibraryRelationType, bool) {
	type getResult interface {
...
func (o *BTMReadOnlyParameter3800) HasLibraryRelationType() bool {
	type getResult interface {
...
func (o *BTMReadOnlyParameter3800) SetLibraryRelationType(v GBTParameterLibraryRelationType) {
	type getResult interface {
...
// and a boolean to check if the value has been set.
func (o *BTMReadOnlyParameter3800) GetValueStringOk() (*string, bool) {
	type getResult interface {
...
func (o *BTMReadOnlyParameter3800) HasValueString() bool {
	type getResult interface {
		HasValueString() bool
	}
...
func (o *BTMReadOnlyParameter3800) SetValueString(v string) {
	type getResult interface {
...
// GetLibraryRelationType returns the LibraryRelationType field value if set, zero value otherwise.
func (o *base_BTMReadOnlyParameter3800) GetLibraryRelationType() GBTParameterLibraryRelationType {
...
// GetLibraryRelationTypeOk returns a tuple with the LibraryRelationType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTMReadOnlyParameter3800) GetLibraryRelationTypeOk() (*GBTParameterLibraryRelationType, bool) {
	if o == nil || o.LibraryRelationType == nil {
		return nil, false
	}
...
// HasLibraryRelationType returns a boolean if a field has been set.
func (o *base_BTMReadOnlyParameter3800) HasLibraryRelationType() bool {
	if o != nil && o.LibraryRelationType != nil {
		return true
	}
...
// SetLibraryRelationType gets a reference to the given GBTParameterLibraryRelationType and assigns it to the LibraryRelationType field.
func (o *base_BTMReadOnlyParameter3800) SetLibraryRelationType(v GBTParameterLibraryRelationType) {
...
// GetValueStringOk returns a tuple with the ValueString field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTMReadOnlyParameter3800) GetValueStringOk() (*string, bool) {
	if o == nil || o.ValueString == nil {
		return nil, false
	}
...
// HasValueString returns a boolean if a field has been set.
func (o *base_BTMReadOnlyParameter3800) HasValueString() bool {
	if o != nil && o.ValueString != nil {
		return true
	}
...
// SetValueString gets a reference to the given string and assigns it to the ValueString field.
func (o *base_BTMReadOnlyParameter3800) SetValueString(v string) {
	o.ValueString = &v
}
