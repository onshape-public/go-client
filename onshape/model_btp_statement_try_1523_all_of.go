...
func (o BTPStatementTry1523AllOf) MarshalJSON() ([]byte, error) {
...
type NullableBTPStatementTry1523AllOf struct {
	value *BTPStatementTry1523AllOf
	isSet bool
}

func (v NullableBTPStatementTry1523AllOf) Get() *BTPStatementTry1523AllOf {
	return v.value
}

func (v *NullableBTPStatementTry1523AllOf) Set(val *BTPStatementTry1523AllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBTPStatementTry1523AllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBTPStatementTry1523AllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTPStatementTry1523AllOf(val *BTPStatementTry1523AllOf) *NullableBTPStatementTry1523AllOf {
	return &NullableBTPStatementTry1523AllOf{value: val, isSet: true}
}

func (v NullableBTPStatementTry1523AllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTPStatementTry1523AllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
