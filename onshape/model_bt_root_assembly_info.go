...
func (o BTRootAssemblyInfo) MarshalJSON() ([]byte, error) {
...
type NullableBTRootAssemblyInfo struct {
	value *BTRootAssemblyInfo
	isSet bool
}

func (v NullableBTRootAssemblyInfo) Get() *BTRootAssemblyInfo {
	return v.value
}

func (v *NullableBTRootAssemblyInfo) Set(val *BTRootAssemblyInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableBTRootAssemblyInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableBTRootAssemblyInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTRootAssemblyInfo(val *BTRootAssemblyInfo) *NullableBTRootAssemblyInfo {
	return &NullableBTRootAssemblyInfo{value: val, isSet: true}
}

func (v NullableBTRootAssemblyInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTRootAssemblyInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
