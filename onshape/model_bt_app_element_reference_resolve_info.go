...
type BTAppElementReferenceResolveInfo struct {
	...
	ResolvedConfiguration          *string                `json:"resolvedConfiguration,omitempty"`
...
// GetResolvedConfiguration returns the ResolvedConfiguration field value if set, zero value otherwise.
func (o *BTAppElementReferenceResolveInfo) GetResolvedConfiguration() string {
	if o == nil || o.ResolvedConfiguration == nil {
		var ret string
		return ret
	}
	return *o.ResolvedConfiguration
}

// GetResolvedConfigurationOk returns a tuple with the ResolvedConfiguration field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BTAppElementReferenceResolveInfo) GetResolvedConfigurationOk() (*string, bool) {
	if o == nil || o.ResolvedConfiguration == nil {
		return nil, false
	}
	return o.ResolvedConfiguration, true
}
...
// SetResolvedConfiguration gets a reference to the given string and assigns it to the ResolvedConfiguration field.
func (o *BTAppElementReferenceResolveInfo) SetResolvedConfiguration(v string) {
	o.ResolvedConfiguration = &v
}
...
func (o BTAppElementReferenceResolveInfo) MarshalJSON() ([]byte, error) {
	...
	if o.ResolvedConfiguration != nil {
		toSerialize["resolvedConfiguration"] = o.ResolvedConfiguration
	}
