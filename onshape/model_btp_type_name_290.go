...
type BTPTypeName290 struct {
	implBTPTypeName290 interface{}
}

// BTPTypeNameUser292AsBTPTypeName290 is a convenience function that returns BTPTypeNameUser292 wrapped in BTPTypeName290
func (o *BTPTypeNameUser292) AsBTPTypeName290() *BTPTypeName290 {
	return &BTPTypeName290{o}
}

// BTPTypeNameStandard291AsBTPTypeName290 is a convenience function that returns BTPTypeNameStandard291 wrapped in BTPTypeName290
func (o *BTPTypeNameStandard291) AsBTPTypeName290() *BTPTypeName290 {
	return &BTPTypeName290{o}
}
...
func NewBTPTypeName290() *BTPTypeName290 {
	this := BTPTypeName290{Newbase_BTPTypeName290()}
	return &this
}
...
func NewBTPTypeName290WithDefaults() *BTPTypeName290 {
	this := BTPTypeName290{Newbase_BTPTypeName290WithDefaults()}
	return &this
}
...
func (dst *BTPTypeName290) UnmarshalJSON(data []byte) error {
	var err error
	...
	var qtx *base_BTPTypeName290
	err = json.Unmarshal(data, &qtx)
	if err == nil {
		dst.implBTPTypeName290 = qtx
...
func (src BTPTypeName290) MarshalJSON() ([]byte, error) {
...
func (obj *BTPTypeName290) GetActualInstance() interface{} {
	if obj == nil {
		return nil
	}
	return obj.implBTPTypeName290
}
...
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func Newbase_BTPTypeName290() *base_BTPTypeName290 {
	this := base_BTPTypeName290{}
	return &this
}

// Newbase_BTPTypeName290WithDefaults instantiates a new base_BTPTypeName290 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func Newbase_BTPTypeName290WithDefaults() *base_BTPTypeName290 {
	this := base_BTPTypeName290{}
	return &this
}

// GetAtomic returns the Atomic field value if set, zero value otherwise.
func (o *base_BTPTypeName290) GetAtomic() bool {
...
// GetAtomicOk returns a tuple with the Atomic field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTPTypeName290) GetAtomicOk() (*bool, bool) {
	if o == nil || o.Atomic == nil {
		return nil, false
	}
...
// HasAtomic returns a boolean if a field has been set.
func (o *base_BTPTypeName290) HasAtomic() bool {
	if o != nil && o.Atomic != nil {
		return true
	}
...
// SetAtomic gets a reference to the given bool and assigns it to the Atomic field.
func (o *base_BTPTypeName290) SetAtomic(v bool) {
	o.Atomic = &v
}

// GetBtType returns the BtType field value if set, zero value otherwise.
func (o *base_BTPTypeName290) GetBtType() string {
...
// GetBtTypeOk returns a tuple with the BtType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTPTypeName290) GetBtTypeOk() (*string, bool) {
	if o == nil || o.BtType == nil {
		return nil, false
	}
...
// HasBtType returns a boolean if a field has been set.
func (o *base_BTPTypeName290) HasBtType() bool {
	if o != nil && o.BtType != nil {
		return true
	}
...
// SetBtType gets a reference to the given string and assigns it to the BtType field.
func (o *base_BTPTypeName290) SetBtType(v string) {
	o.BtType = &v
}
...
// HasDocumentationType returns a boolean if a field has been set.
func (o *base_BTPTypeName290) HasDocumentationType() bool {
	if o != nil && o.DocumentationType != nil {
		return true
	}
...
// GetEndSourceLocation returns the EndSourceLocation field value if set, zero value otherwise.
func (o *base_BTPTypeName290) GetEndSourceLocation() int32 {
...
// GetEndSourceLocationOk returns a tuple with the EndSourceLocation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTPTypeName290) GetEndSourceLocationOk() (*int32, bool) {
	if o == nil || o.EndSourceLocation == nil {
		return nil, false
	}
...
// HasEndSourceLocation returns a boolean if a field has been set.
func (o *base_BTPTypeName290) HasEndSourceLocation() bool {
	if o != nil && o.EndSourceLocation != nil {
		return true
	}
...
// SetEndSourceLocation gets a reference to the given int32 and assigns it to the EndSourceLocation field.
func (o *base_BTPTypeName290) SetEndSourceLocation(v int32) {
	o.EndSourceLocation = &v
}

// GetNodeId returns the NodeId field value if set, zero value otherwise.
func (o *base_BTPTypeName290) GetNodeId() string {
...
// GetNodeIdOk returns a tuple with the NodeId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTPTypeName290) GetNodeIdOk() (*string, bool) {
	if o == nil || o.NodeId == nil {
		return nil, false
	}
...
// HasNodeId returns a boolean if a field has been set.
func (o *base_BTPTypeName290) HasNodeId() bool {
	if o != nil && o.NodeId != nil {
		return true
	}
...
// SetNodeId gets a reference to the given string and assigns it to the NodeId field.
func (o *base_BTPTypeName290) SetNodeId(v string) {
	o.NodeId = &v
}

// GetShortDescriptor returns the ShortDescriptor field value if set, zero value otherwise.
func (o *base_BTPTypeName290) GetShortDescriptor() string {
...
// GetShortDescriptorOk returns a tuple with the ShortDescriptor field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTPTypeName290) GetShortDescriptorOk() (*string, bool) {
	if o == nil || o.ShortDescriptor == nil {
		return nil, false
	}
...
// HasShortDescriptor returns a boolean if a field has been set.
func (o *base_BTPTypeName290) HasShortDescriptor() bool {
	if o != nil && o.ShortDescriptor != nil {
		return true
	}
...
// SetShortDescriptor gets a reference to the given string and assigns it to the ShortDescriptor field.
func (o *base_BTPTypeName290) SetShortDescriptor(v string) {
	o.ShortDescriptor = &v
}

// GetSpaceAfter returns the SpaceAfter field value if set, zero value otherwise.
func (o *base_BTPTypeName290) GetSpaceAfter() BTPSpace10 {
...
// GetSpaceAfterOk returns a tuple with the SpaceAfter field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTPTypeName290) GetSpaceAfterOk() (*BTPSpace10, bool) {
	if o == nil || o.SpaceAfter == nil {
		return nil, false
	}
...
// HasSpaceAfter returns a boolean if a field has been set.
func (o *base_BTPTypeName290) HasSpaceAfter() bool {
	if o != nil && o.SpaceAfter != nil {
		return true
	}
...
// SetSpaceAfter gets a reference to the given BTPSpace10 and assigns it to the SpaceAfter field.
func (o *base_BTPTypeName290) SetSpaceAfter(v BTPSpace10) {
	o.SpaceAfter = &v
}

// GetSpaceBefore returns the SpaceBefore field value if set, zero value otherwise.
func (o *base_BTPTypeName290) GetSpaceBefore() BTPSpace10 {
...
// GetSpaceBeforeOk returns a tuple with the SpaceBefore field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTPTypeName290) GetSpaceBeforeOk() (*BTPSpace10, bool) {
	if o == nil || o.SpaceBefore == nil {
		return nil, false
	}
...
// HasSpaceBefore returns a boolean if a field has been set.
func (o *base_BTPTypeName290) HasSpaceBefore() bool {
	if o != nil && o.SpaceBefore != nil {
		return true
	}
...
// SetSpaceBefore gets a reference to the given BTPSpace10 and assigns it to the SpaceBefore field.
func (o *base_BTPTypeName290) SetSpaceBefore(v BTPSpace10) {
	o.SpaceBefore = &v
}

// GetSpaceDefault returns the SpaceDefault field value if set, zero value otherwise.
func (o *base_BTPTypeName290) GetSpaceDefault() bool {
...
// GetSpaceDefaultOk returns a tuple with the SpaceDefault field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTPTypeName290) GetSpaceDefaultOk() (*bool, bool) {
	if o == nil || o.SpaceDefault == nil {
		return nil, false
	}
...
// HasSpaceDefault returns a boolean if a field has been set.
func (o *base_BTPTypeName290) HasSpaceDefault() bool {
	if o != nil && o.SpaceDefault != nil {
		return true
	}
...
// SetSpaceDefault gets a reference to the given bool and assigns it to the SpaceDefault field.
func (o *base_BTPTypeName290) SetSpaceDefault(v bool) {
	o.SpaceDefault = &v
}

// GetStartSourceLocation returns the StartSourceLocation field value if set, zero value otherwise.
func (o *base_BTPTypeName290) GetStartSourceLocation() int32 {
...
// GetStartSourceLocationOk returns a tuple with the StartSourceLocation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTPTypeName290) GetStartSourceLocationOk() (*int32, bool) {
	if o == nil || o.StartSourceLocation == nil {
		return nil, false
	}
...
// HasStartSourceLocation returns a boolean if a field has been set.
func (o *base_BTPTypeName290) HasStartSourceLocation() bool {
	if o != nil && o.StartSourceLocation != nil {
		return true
	}
...
// SetStartSourceLocation gets a reference to the given int32 and assigns it to the StartSourceLocation field.
func (o *base_BTPTypeName290) SetStartSourceLocation(v int32) {
	o.StartSourceLocation = &v
}

func (o base_BTPTypeName290) MarshalJSON() ([]byte, error) {
