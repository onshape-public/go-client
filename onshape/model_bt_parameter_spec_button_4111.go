...
func (o *BTParameterSpecButton4111) GetEnumOptions() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecButton4111) GetEnumOptionsOk() ([]string, bool) {
	if o == nil || o.EnumOptions == nil {
		return nil, false
	}
...
func (o *BTParameterSpecButton4111) HasEnumOptions() bool {
	if o != nil && o.EnumOptions != nil {
		return true
	}
...
func (o *BTParameterSpecButton4111) SetEnumOptions(v []string) {
	o.EnumOptions = v
}
