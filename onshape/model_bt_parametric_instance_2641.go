...
func (o *BTParametricInstance2641) GetMicroversionId() BTMicroversionId366 {
	type getResult interface {
...
// and a boolean to check if the value has been set.
func (o *BTParametricInstance2641) GetMicroversionIdOk() (*BTMicroversionId366, bool) {
	type getResult interface {
...
func (o *BTParametricInstance2641) HasMicroversionId() bool {
	type getResult interface {
...
func (o *BTParametricInstance2641) SetMicroversionId(v BTMicroversionId366) {
	type getResult interface {
...
// GetMicroversionId returns the MicroversionId field value if set, zero value otherwise.
func (o *base_BTParametricInstance2641) GetMicroversionId() BTMicroversionId366 {
...
// GetMicroversionIdOk returns a tuple with the MicroversionId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTParametricInstance2641) GetMicroversionIdOk() (*BTMicroversionId366, bool) {
	if o == nil || o.MicroversionId == nil {
		return nil, false
	}
...
// HasMicroversionId returns a boolean if a field has been set.
func (o *base_BTParametricInstance2641) HasMicroversionId() bool {
	if o != nil && o.MicroversionId != nil {
		return true
	}
...
// SetMicroversionId gets a reference to the given BTMicroversionId366 and assigns it to the MicroversionId field.
func (o *base_BTParametricInstance2641) SetMicroversionId(v BTMicroversionId366) {
	o.MicroversionId = &v
}
