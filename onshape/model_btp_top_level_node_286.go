...
// BTPFunctionDeclaration246AsBTPTopLevelNode286 is a convenience function that returns BTPFunctionDeclaration246 wrapped in BTPTopLevelNode286
func (o *BTPFunctionDeclaration246) AsBTPTopLevelNode286() *BTPTopLevelNode286 {
	return &BTPTopLevelNode286{o}
}
...
func (o *BTPTopLevelNode286) GetDocumentationType() string {
	type getResult interface {
...
// and a boolean to check if the value has been set.
func (o *BTPTopLevelNode286) GetDocumentationTypeOk() (*string, bool) {
	type getResult interface {
...
func (o *BTPTopLevelNode286) SetDocumentationType(v string) {
	type getResult interface {
...
func (dst *BTPTopLevelNode286) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["btType"] == "BTPFunctionDeclaration-246" {
		...
		if err == nil {
			...
			dst.implBTPTopLevelNode286 = nil
			return fmt.Errorf("Failed to unmarshal BTPTopLevelNode286 as BTPFunctionDeclaration246: %s", err.Error())
		}
	}
...
// GetDocumentationType returns the DocumentationType field value if set, zero value otherwise.
func (o *base_BTPTopLevelNode286) GetDocumentationType() string {
...
// GetDocumentationTypeOk returns a tuple with the DocumentationType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTPTopLevelNode286) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
// SetDocumentationType gets a reference to the given string and assigns it to the DocumentationType field.
func (o *base_BTPTopLevelNode286) SetDocumentationType(v string) {
