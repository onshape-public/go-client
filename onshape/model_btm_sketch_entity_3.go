...
// BTMSketchCurvedTextEntity5708AsBTMSketchEntity3 is a convenience function that returns BTMSketchCurvedTextEntity5708 wrapped in BTMSketchEntity3
func (o *BTMSketchCurvedTextEntity5708) AsBTMSketchEntity3() *BTMSketchEntity3 {
	return &BTMSketchEntity3{o}
}
...
func (dst *BTMSketchEntity3) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["btType"] == "BTMSketchCurvedTextEntity-5708" {
		...
		if err == nil {
			...
			dst.implBTMSketchEntity3 = nil
			return fmt.Errorf("failed to unmarshal BTMSketchEntity3 as BTMSketchCurvedTextEntity5708: %s", err.Error())
		}
	}
