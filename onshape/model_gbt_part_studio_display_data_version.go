...
const (
	V0_ORIGINAL_VERSION               GBTPartStudioDisplayDataVersion = "V0_ORIGINAL_VERSION"
	V1_SMOOTH_EDGES_RENDERING_OPTIONS GBTPartStudioDisplayDataVersion = "V1_SMOOTH_EDGES_RENDERING_OPTIONS"
	V2_SMOOTH_EDGES_TOLERANCE_CHANGED GBTPartStudioDisplayDataVersion = "V2_SMOOTH_EDGES_TOLERANCE_CHANGED"
