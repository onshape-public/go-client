...
func (o *BTPTopLevelUserTypeDeclaration288) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPTopLevelUserTypeDeclaration288) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPTopLevelUserTypeDeclaration288) SetDocumentationType(v string) {
