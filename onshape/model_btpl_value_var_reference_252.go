...
func (o *BTPLValueVarReference252) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPLValueVarReference252) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPLValueVarReference252) SetDocumentationType(v string) {
