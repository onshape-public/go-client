...
// GetBtType returns the BtType field value if set, zero value otherwise.
func (o *base_BTExportTessellatedBody3398) GetBtType() string {
...
// GetBtTypeOk returns a tuple with the BtType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTExportTessellatedBody3398) GetBtTypeOk() (*string, bool) {
	if o == nil || o.BtType == nil {
		return nil, false
	}
...
// HasBtType returns a boolean if a field has been set.
func (o *base_BTExportTessellatedBody3398) HasBtType() bool {
	if o != nil && o.BtType != nil {
		return true
	}
...
// SetBtType gets a reference to the given string and assigns it to the BtType field.
func (o *base_BTExportTessellatedBody3398) SetBtType(v string) {
	o.BtType = &v
}
