...
const (
	...
	TestAPISecretKey = "test_onshape_api_secret_key"
	TestAPIAccessKey = "test_onshape_api_access_key"
	BaseURL          = "ONSHAPE_BASE_URL"
	HTTPDebug        = "ONSHAPE_HTTP_DEBUG"
	//experimental and temporary
	BulkAppElement = "ONSHAPE_BULK_APP_ELEMENT"
)
...
func GetAddAPIKeysReqHdrsFunc() HdrProcFunc {
	...
	//TODO: remove once we start using above variables
