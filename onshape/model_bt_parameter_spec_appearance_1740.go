...
func (o *BTParameterSpecAppearance1740) GetEnumOptions() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecAppearance1740) GetEnumOptionsOk() ([]string, bool) {
	if o == nil || o.EnumOptions == nil {
		return nil, false
	}
...
func (o *BTParameterSpecAppearance1740) HasEnumOptions() bool {
	if o != nil && o.EnumOptions != nil {
		return true
	}
...
func (o *BTParameterSpecAppearance1740) SetEnumOptions(v []string) {
	o.EnumOptions = v
}
