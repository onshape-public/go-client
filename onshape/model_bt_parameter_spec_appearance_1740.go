...
func (o *BTParameterSpecAppearance1740) GetUiHints() []string {
...
// and a boolean to check if the value has been set.
func (o *BTParameterSpecAppearance1740) GetUiHintsOk() ([]string, bool) {
	if o == nil || o.UiHints == nil {
		return nil, false
	}
...
func (o *BTParameterSpecAppearance1740) SetUiHints(v []string) {
	o.UiHints = v
}
