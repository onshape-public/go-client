...
func (o *BTMIndividualQueryWithOccurrence811) GetNodeIdFromCurrentQuery() string {
	type getResult interface {
...
// and a boolean to check if the value has been set.
func (o *BTMIndividualQueryWithOccurrence811) GetNodeIdFromCurrentQueryOk() (*string, bool) {
	type getResult interface {
...
func (o *BTMIndividualQueryWithOccurrence811) HasNodeIdFromCurrentQuery() bool {
	type getResult interface {
...
func (o *BTMIndividualQueryWithOccurrence811) SetNodeIdFromCurrentQuery(v string) {
	type getResult interface {
...
func (o *BTMIndividualQueryWithOccurrence811) GetQueryPath() []string {
	type getResult interface {
		GetQueryPath() []string
	}
...
// and a boolean to check if the value has been set.
func (o *BTMIndividualQueryWithOccurrence811) GetQueryPathOk() ([]string, bool) {
	type getResult interface {
...
func (o *BTMIndividualQueryWithOccurrence811) HasQueryPath() bool {
	type getResult interface {
		HasQueryPath() bool
	}
...
func (o *BTMIndividualQueryWithOccurrence811) SetQueryPath(v []string) {
	type getResult interface {
...
// GetNodeIdFromCurrentQuery returns the NodeIdFromCurrentQuery field value if set, zero value otherwise.
func (o *base_BTMIndividualQueryWithOccurrence811) GetNodeIdFromCurrentQuery() string {
...
// GetNodeIdFromCurrentQueryOk returns a tuple with the NodeIdFromCurrentQuery field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTMIndividualQueryWithOccurrence811) GetNodeIdFromCurrentQueryOk() (*string, bool) {
	if o == nil || o.NodeIdFromCurrentQuery == nil {
		return nil, false
	}
...
// HasNodeIdFromCurrentQuery returns a boolean if a field has been set.
func (o *base_BTMIndividualQueryWithOccurrence811) HasNodeIdFromCurrentQuery() bool {
	if o != nil && o.NodeIdFromCurrentQuery != nil {
		return true
	}
...
// SetNodeIdFromCurrentQuery gets a reference to the given string and assigns it to the NodeIdFromCurrentQuery field.
func (o *base_BTMIndividualQueryWithOccurrence811) SetNodeIdFromCurrentQuery(v string) {
...
// GetQueryPath returns the QueryPath field value if set, zero value otherwise.
func (o *base_BTMIndividualQueryWithOccurrence811) GetQueryPath() []string {
...
// GetQueryPathOk returns a tuple with the QueryPath field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *base_BTMIndividualQueryWithOccurrence811) GetQueryPathOk() ([]string, bool) {
	if o == nil || o.QueryPath == nil {
		return nil, false
	}
...
// HasQueryPath returns a boolean if a field has been set.
func (o *base_BTMIndividualQueryWithOccurrence811) HasQueryPath() bool {
	if o != nil && o.QueryPath != nil {
		return true
	}
...
// SetQueryPath gets a reference to the given []string and assigns it to the QueryPath field.
func (o *base_BTMIndividualQueryWithOccurrence811) SetQueryPath(v []string) {
	o.QueryPath = v
}
