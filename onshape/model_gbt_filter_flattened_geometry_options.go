...
const (
	MODEL_ONLY          GBTFilterFlattenedGeometryOptions = "MODEL_ONLY"
	FLATTENED_ONLY      GBTFilterFlattenedGeometryOptions = "FLATTENED_ONLY"
	MODEL_AND_FLATTENED GBTFilterFlattenedGeometryOptions = "MODEL_AND_FLATTENED"
