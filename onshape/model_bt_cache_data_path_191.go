...
type BTCacheDataPath191 struct {
	...
	CanAcceptNewContext              *bool   `json:"canAcceptNewContext,omitempty"`
...
// GetCanAcceptNewContext returns the CanAcceptNewContext field value if set, zero value otherwise.
func (o *BTCacheDataPath191) GetCanAcceptNewContext() bool {
	if o == nil || o.CanAcceptNewContext == nil {
		var ret bool
		return ret
	}
	return *o.CanAcceptNewContext
}

// GetCanAcceptNewContextOk returns a tuple with the CanAcceptNewContext field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BTCacheDataPath191) GetCanAcceptNewContextOk() (*bool, bool) {
	if o == nil || o.CanAcceptNewContext == nil {
		return nil, false
	}
	return o.CanAcceptNewContext, true
}
...
// SetCanAcceptNewContext gets a reference to the given bool and assigns it to the CanAcceptNewContext field.
func (o *BTCacheDataPath191) SetCanAcceptNewContext(v bool) {
	o.CanAcceptNewContext = &v
}
...
func (o BTCacheDataPath191) MarshalJSON() ([]byte, error) {
	...
	if o.CanAcceptNewContext != nil {
		toSerialize["canAcceptNewContext"] = o.CanAcceptNewContext
	}
	if o.DocumentId != nil {
