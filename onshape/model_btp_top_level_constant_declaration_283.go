...
func (o *BTPTopLevelConstantDeclaration283) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPTopLevelConstantDeclaration283) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPTopLevelConstantDeclaration283) SetDocumentationType(v string) {
