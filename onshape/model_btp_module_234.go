...
func (o *BTPModule234) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPModule234) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPModule234) SetDocumentationType(v string) {
