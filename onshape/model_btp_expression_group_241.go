...
func (o *BTPExpressionGroup241) GetDocumentationType() string {
...
// and a boolean to check if the value has been set.
func (o *BTPExpressionGroup241) GetDocumentationTypeOk() (*string, bool) {
	if o == nil || o.DocumentationType == nil {
		return nil, false
	}
...
func (o *BTPExpressionGroup241) SetDocumentationType(v string) {
