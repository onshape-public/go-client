...
// BTListResponseBTItemInfo A list of resources that typically supports paging.
type BTListResponseBTItemInfo struct {
	// URI for current page of resources.
	Href *string `json:"href,omitempty"`
	// Array of items in the current page.
	Items []BTItemInfo `json:"items,omitempty"`
...
// SetItems gets a reference to the given []BTItemInfo and assigns it to the Items field.
...
func (o BTListResponseBTItemInfo) MarshalJSON() ([]byte, error) {
...
type NullableBTListResponseBTItemInfo struct {
	value *BTListResponseBTItemInfo
	isSet bool
}

func (v NullableBTListResponseBTItemInfo) Get() *BTListResponseBTItemInfo {
	return v.value
}

func (v *NullableBTListResponseBTItemInfo) Set(val *BTListResponseBTItemInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableBTListResponseBTItemInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableBTListResponseBTItemInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBTListResponseBTItemInfo(val *BTListResponseBTItemInfo) *NullableBTListResponseBTItemInfo {
	return &NullableBTListResponseBTItemInfo{value: val, isSet: true}
}

func (v NullableBTListResponseBTItemInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBTListResponseBTItemInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
