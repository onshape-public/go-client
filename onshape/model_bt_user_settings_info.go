...
func (o *BTUserSettingsInfo) GetUnitsDisplayPrecision() BTUnitsDisplayPrecision {
	if o == nil || o.UnitsDisplayPrecision == nil {
		var ret BTUnitsDisplayPrecision
		return ret
	}
...
// SetUnitsDisplayPrecision gets a reference to the given BTUnitsDisplayPrecision and assigns it to the UnitsDisplayPrecision field.
