...
// BTPLiteralNumber258AsBTPPropertyAccessor23 is a convenience function that returns BTPLiteralNumber258 wrapped in BTPPropertyAccessor23
func (o *BTPLiteralNumber258) AsBTPPropertyAccessor23() *BTPPropertyAccessor23 {
	return &BTPPropertyAccessor23{o}
}
...
func (dst *BTPPropertyAccessor23) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["btType"] == "BTPLiteralNumber-258" {
		...
		if err == nil {
			...
			dst.implBTPPropertyAccessor23 = nil
			return fmt.Errorf("Failed to unmarshal BTPPropertyAccessor23 as BTPLiteralNumber258: %s", err.Error())
		}
	}
